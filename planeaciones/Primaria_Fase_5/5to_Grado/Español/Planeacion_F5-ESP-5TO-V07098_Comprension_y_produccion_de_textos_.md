---
tags: [iskool, planeacion_nem, segundo_cerebro, fase5, campo_lenguajes, grado_5to_grado, materia_espanol, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_rural_agricola]
id_planeacion: "F5-ESP-5TO-V07098"
campo_formativo: "Lenguajes"
materia: "Español"
grado: "5º de Primaria"
nivel: "Primaria Fase 5"
tema: "Comprensión y producción de textos discontinuos (tablas y líneas del tiempo)"
...
fecha_creacion: "2026-08-24T20:08:02.234Z"
---

# 📚 Proyecto Didáctico Integral: Comprensión y producción de textos discontinuos (tablas y líneas del tiempo) - Variante 7098 (Rural Agrícola)
...
> **"Analiza características de tablas de doble entrada, líneas del tiempo y cuadros cronológicos para sintetizar y presentar información legible al público."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Comprensión y producción de textos discontinuos (tablas y líneas del tiempo)"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Rural Agrícola)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Comprensión y producción de textos discontinuos (tablas y líneas del tiempo)"*.
