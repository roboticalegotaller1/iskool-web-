---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase5, campo_saberes_y_pensamiento_cientifico, grado_5to_grado, materia_ciencias_naturales, metodologia_steam_con_robotica_pensamiento_computacional_e_indagacion, contexto_zona_costera_y_de_humedales, codiseno_2026]
id_planeacion: "SERIE2-F5-CIE-5TO-V19089"
...
fecha_creacion: "2026-08-24T21:50:21.845Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Reproducción humana: fecundación, embarazo y parto responsable - Modalidad Innovadora 9089 (Zona Costera y de Humedales)
...
1. **¿Cómo podemos transformar el estudio de *"Reproducción humana: fecundación, embarazo y parto responsable"* en una solución práctica para atender el reto de: *Protección de arrecifes, reforestación de manglares y gestión del agua potable ante el impacto del cambio climático.*?**
...
> **Guía de campo ilustrada y herbario digital interactivo con fichas botánicas** aplicado a la atención situada de: *Protección de arrecifes, reforestación de manglares y gestión del agua potable ante el impacto del cambio climático.*.
...
- Etiquetas: #saberes_y_pensamiento_cientifico • #ciencias_naturales • #5to_grado • #steam_con_robotica_pensamiento_computacional_e_indagacion • #codiseno_2026
