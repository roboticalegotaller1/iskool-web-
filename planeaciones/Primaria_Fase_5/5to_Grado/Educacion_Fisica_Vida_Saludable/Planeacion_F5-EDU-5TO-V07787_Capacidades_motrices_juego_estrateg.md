---
tags: [iskool, planeacion_nem, segundo_cerebro, fase5, campo_de_lo_humano_y_lo_comunitario, grado_5to_grado, materia_educacion_fisica_vida_saludable, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_comunitario_indigena_y_bilingue]
id_planeacion: "F5-EDU-5TO-V07787"
...
contexto_comunitario: "Comunitario Indígena y Bilingüe"
problematica_situada: "Rescate de saberes ancestrales de la lengua originaria, medicina tradicional y faenas comunitarias (tequio)."
ejes_articuladores: ["Inclusión", "Vida Saludable", "Interculturalidad Crítica"]
duracion: "10 sesiones de 50 minutos (Total: 500 min)"
fecha_creacion: "2026-08-24T20:08:03.326Z"
---

# 📚 Proyecto Didáctico Integral: Capacidades motrices, juego estratégico y trabajo colaborativo - Variante 7787 (Comunitario Indígena y Bilingüe)
...
> - **Contexto de Aplicación:** Comunitario Indígena y Bilingüe (Enfoque: *Rescate de saberes ancestrales de la lengua originaria, medicina tradicional y faenas comunitarias (tequio).*)
> - **Ejes Articuladores SEP:** Inclusión • Vida Saludable • Interculturalidad Crítica
...
1. **¿De qué manera el contenido de *"Capacidades motrices, juego estratégico y trabajo colaborativo"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Comunitario Indígena y Bilingüe)?**
...
- **Sesión 1: Apertura y Encuadre Cognitivo (50 min)**
  - *Inicio (10 min):* Presentación de la situación problemática en el contexto Comunitario Indígena y Bilingüe. El docente Prof. Israel López Ángeles plantea las preguntas detonadoras.
  - *Desarrollo (30 min):* Lluvia de ideas estructurada y debate guiado sobre experiencias comunitarias vinculadas a: *Rescate de saberes ancestrales de la lengua originaria, medicina tradicional y faenas comunitarias (tequio).*. Organización de equipos de trabajo colaborativo heterogéneos.
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Capacidades motrices, juego estratégico y trabajo colaborativo"*.
...
- **Sesión 5: Discusión y Vinculación Interdisciplinar (50 min)**
  - *Inicio (10 min):* Conexión del tema con los ejes articuladores: *Inclusión, Vida Saludable, Interculturalidad Crítica*.
...
- **Sesión 6: Diseño y Bocetaje del Entregable (50 min)**
  ...
  - *Desarrollo (30 min):* Taller creativo en equipos: diseño del primer prototipo o borrador de: *Huerto escolar biointensivo con bitácora de observación y mediciones métricas*.
...
> **Huerto escolar biointensivo con bitácora de observación y mediciones métricas** enfocado en la resolución situada de: *Rescate de saberes ancestrales de la lengua originaria, medicina tradicional y faenas comunitarias (tequio).*.
...
- Etiquetas: #de_lo_humano_y_lo_comunitario • #educacion_fisica_vida_saludable • #5to_grado • #steam_con_enfoque_de_indagacion_cientifica_y_robotica
