---
tags: [iskool, planeacion_nem, segundo_cerebro, fase5, campo_saberes_y_pensamiento_cientifico, grado_5to_grado, materia_matematicas, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_rural_agricola]
id_planeacion: "F5-MAT-5TO-V07938"
campo_formativo: "Saberes y Pensamiento Científico"
materia: "Matematicas"
grado: "5º de Primaria"
nivel: "Primaria Fase 5"
tema: "Perímetro, área de polígonos y volumen de prismas rectos"
...
fecha_creacion: "2026-08-24T20:08:03.564Z"
---

# 📚 Proyecto Didáctico Integral: Perímetro, área de polígonos y volumen de prismas rectos - Variante 7938 (Rural Agrícola)
...
> **"Construye fórmulas para calcular áreas de triángulos, romboides y rectángulos (m², cm²), estimando volúmenes de prismas rectangulares mediante conteo de cubos."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Perímetro, área de polígonos y volumen de prismas rectos"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Rural Agrícola)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Perímetro, área de polígonos y volumen de prismas rectos"*.
