---
tags: [iskool, planeacion_nem, segundo_cerebro, fase5, campo_saberes_y_pensamiento_cientifico, grado_5to_grado, materia_matematicas, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_urbano_metropolitano]
id_planeacion: "F5-MAT-5TO-V03017"
...
fecha_creacion: "2026-08-24T20:07:55.496Z"
---

# 📚 Proyecto Didáctico Integral: Proporcionalidad y porcentajes (50%, 25%, 20%, 10%) - Variante 3017 (Urbano Metropolitano)
...
1. **¿De qué manera el contenido de *"Proporcionalidad y porcentajes (50%, 25%, 20%, 10%)"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Urbano Metropolitano)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Proporcionalidad y porcentajes (50%, 25%, 20%, 10%)"*.
