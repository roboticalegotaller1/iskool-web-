---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase5, campo_saberes_y_pensamiento_cientifico, grado_5to_grado, materia_matematicas, metodologia_steam_con_robotica_pensamiento_computacional_e_indagacion, contexto_comunidad_escolar_multicultural_y_migrante, codiseno_2026]
id_planeacion: "SERIE2-F5-MAT-5TO-V12453"
...
fecha_creacion: "2026-08-24T21:50:12.170Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Proporcionalidad y porcentajes (50%, 25%, 20%, 10%) - Modalidad Innovadora 2453 (Comunidad Escolar Multicultural y Migrante)
...
> **"Determina valores faltantes en tablas de proporcionalidad directa con valor unitario y calcula porcentajes vinculándolos con fracciones (1/2, 1/4, 1/5, 1/10)."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Innovador

1. **¿Cómo podemos transformar el estudio de *"Proporcionalidad y porcentajes (50%, 25%, 20%, 10%)"* en una solución práctica para atender el reto de: *Integración inclusiva de familias en tránsito, cultura de paz y erradicación de toda forma de discriminación.*?**
...
- **Sesión 2: Mapeo Conceptual y Rescate de Saberes Previos (50 min)**
  - *Inicio (10 min):* Dinámica de preguntas cruzadas entre equipos sobre conceptos clave de *"Proporcionalidad y porcentajes (50%, 25%, 20%, 10%)"*.
...
- **Sesión 4: Laboratorio Práctico / Experimentación y Prototipado (50 min)**
  ...
  - *Desarrollo (30 min):* Realización de experimentos, mediciones matemáticas, cálculos o modelado concreto enfocado en *"Proporcionalidad y porcentajes (50%, 25%, 20%, 10%)"*.
...
- Etiquetas: #saberes_y_pensamiento_cientifico • #matematicas • #5to_grado • #steam_con_robotica_pensamiento_computacional_e_indagacion • #codiseno_2026
