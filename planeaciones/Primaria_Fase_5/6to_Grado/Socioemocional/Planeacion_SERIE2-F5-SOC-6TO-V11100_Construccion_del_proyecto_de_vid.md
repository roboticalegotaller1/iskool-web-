---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase5, campo_de_lo_humano_y_lo_comunitario, grado_6to_grado, materia_socioemocional, metodologia_steam_con_robotica_pensamiento_computacional_e_indagacion, contexto_zona_lacustre_y_de_riberas, codiseno_2026]
id_planeacion: "SERIE2-F5-SOC-6TO-V11100"
...
fecha_creacion: "2026-08-24T21:50:10.229Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Construcción del proyecto de vida y transición a la secundaria - Modalidad Innovadora 1100 (Zona Lacustre y de Riberas)
...
> **"Evalúa logros personales en la primaria y formula metas formativas para el ingreso a la secundaria, fortaleciendo la autonomía y el sentido comunitario."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Innovador

1. **¿Cómo podemos transformar el estudio de *"Construcción del proyecto de vida y transición a la secundaria"* en una solución práctica para atender el reto de: *Saneamiento de cuerpos de agua, agricultura en chinampas y preservación de la biodiversidad acuática.*?**
...
- **Sesión 2: Mapeo Conceptual y Rescate de Saberes Previos (50 min)**
  - *Inicio (10 min):* Dinámica de preguntas cruzadas entre equipos sobre conceptos clave de *"Construcción del proyecto de vida y transición a la secundaria"*.
...
- **Sesión 4: Laboratorio Práctico / Experimentación y Prototipado (50 min)**
  ...
  - *Desarrollo (30 min):* Realización de experimentos, mediciones matemáticas, cálculos o modelado concreto enfocado en *"Construcción del proyecto de vida y transición a la secundaria"*.
...
> **Campaña comunitaria multiplataforma con carteles infográficos y spots de audio** aplicado a la atención situada de: *Saneamiento de cuerpos de agua, agricultura en chinampas y preservación de la biodiversidad acuática.*.
...
- Etiquetas: #de_lo_humano_y_lo_comunitario • #socioemocional • #6to_grado • #steam_con_robotica_pensamiento_computacional_e_indagacion • #codiseno_2026
