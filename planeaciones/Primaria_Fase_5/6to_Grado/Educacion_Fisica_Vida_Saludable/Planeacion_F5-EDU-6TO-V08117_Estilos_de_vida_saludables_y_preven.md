---
tags: [iskool, planeacion_nem, segundo_cerebro, fase5, campo_de_lo_humano_y_lo_comunitario, grado_6to_grado, materia_educacion_fisica_vida_saludable, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_semiurbano_e_industrial]
id_planeacion: "F5-EDU-6TO-V08117"
...
contexto_comunitario: "Semiurbano e Industrial"
problematica_situada: "Prevención de contaminación del aire y mantos freáticos, eficiencia energética y comercio justo local."
ejes_articuladores: ["Inclusión", "Vida Saludable", "Interculturalidad Crítica"]
duracion: "10 sesiones de 50 minutos (Total: 500 min)"
fecha_creacion: "2026-08-24T20:08:03.854Z"
---

# 📚 Proyecto Didáctico Integral: Estilos de vida saludables y prevención de enfermedades crónicas - Variante 8117 (Semiurbano e Industrial)
...
> - **Contexto de Aplicación:** Semiurbano e Industrial (Enfoque: *Prevención de contaminación del aire y mantos freáticos, eficiencia energética y comercio justo local.*)
...
1. **¿De qué manera el contenido de *"Estilos de vida saludables y prevención de enfermedades crónicas"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Semiurbano e Industrial)?**
...
- **Sesión 1: Apertura y Encuadre Cognitivo (50 min)**
  - *Inicio (10 min):* Presentación de la situación problemática en el contexto Semiurbano e Industrial. El docente Prof. Israel López Ángeles plantea las preguntas detonadoras.
  - *Desarrollo (30 min):* Lluvia de ideas estructurada y debate guiado sobre experiencias comunitarias vinculadas a: *Prevención de contaminación del aire y mantos freáticos, eficiencia energética y comercio justo local.*. Organización de equipos de trabajo colaborativo heterogéneos.
...
| **Vinculación Situada (Semiurbano e Industrial)** | Conecta de forma crítica y original el aprendizaje con la problemática *"Prevención de contaminación del aire y mantos freáticos, eficiencia energética y comercio justo local."*, proponiendo mejoras viables. | Relaciona adecuadamente el tema con situaciones de su entorno escolar o familiar. | Describe el contexto de forma superficial sin conectar plenamente con el tema de estudio. |
...
> **Huerto escolar biointensivo con bitácora de observación y mediciones métricas** enfocado en la resolución situada de: *Prevención de contaminación del aire y mantos freáticos, eficiencia energética y comercio justo local.*.
