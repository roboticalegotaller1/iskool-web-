---
tags: [iskool, planeacion_nem, segundo_cerebro, fase5, campo_de_lo_humano_y_lo_comunitario, grado_6to_grado, materia_educacion_fisica_vida_saludable, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_urbano_metropolitano]
id_planeacion: "F5-EDU-6TO-V05657"
...
tema: "Estilos de vida saludables y prevención de enfermedades crónicas"
docente: "Prof. Israel López Ángeles"
docente_email: "israel.lopez@iskool.edu.mx"
metodologia: "STEAM con Enfoque de Indagación Científica y Robótica"
contexto_comunitario: "Urbano Metropolitano"
problematica_situada: "Manejo de residuos plásticos, movilidad sustentable y uso crítico de redes sociales en escuelas de alta densidad urbana."
ejes_articuladores: ["Inclusión", "Vida Saludable", "Interculturalidad Crítica"]
duracion: "10 sesiones de 50 minutos (Total: 500 min)"
fecha_creacion: "2026-08-24T20:07:59.701Z"
---

# 📚 Proyecto Didáctico Integral: Estilos de vida saludables y prevención de enfermedades crónicas - Variante 5657 (Urbano Metropolitano)
...
> - **Contexto de Aplicación:** Urbano Metropolitano (Enfoque: *Manejo de residuos plásticos, movilidad sustentable y uso crítico de redes sociales en escuelas de alta densidad urbana.*)
...
> **"Propone alternativas comunitarias de higiene y alimentación saludable baja en sal y azúcares, previniendo diabetes, hipertensión y obesidad infantil."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Estilos de vida saludables y prevención de enfermedades crónicas"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Urbano Metropolitano)?**
...
- **Sesión 1: Apertura y Encuadre Cognitivo (50 min)**
  - *Inicio (10 min):* Presentación de la situación problemática en el contexto Urbano Metropolitano. El docente Prof. Israel López Ángeles plantea las preguntas detonadoras.
  - *Desarrollo (30 min):* Lluvia de ideas estructurada y debate guiado sobre experiencias comunitarias vinculadas a: *Manejo de residuos plásticos, movilidad sustentable y uso crítico de redes sociales en escuelas de alta densidad urbana.*. Organización de equipos de trabajo colaborativo heterogéneos.
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Estilos de vida saludables y prevención de enfermedades crónicas"*.
...
> **Huerto escolar biointensivo con bitácora de observación y mediciones métricas** enfocado en la resolución situada de: *Manejo de residuos plásticos, movilidad sustentable y uso crítico de redes sociales en escuelas de alta densidad urbana.*.
...
- Etiquetas: #de_lo_humano_y_lo_comunitario • #educacion_fisica_vida_saludable • #6to_grado • #steam_con_enfoque_de_indagacion_cientifica_y_robotica
