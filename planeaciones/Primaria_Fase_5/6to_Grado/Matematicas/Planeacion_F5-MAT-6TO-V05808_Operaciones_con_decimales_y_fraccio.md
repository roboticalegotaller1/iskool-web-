---
tags: [iskool, planeacion_nem, segundo_cerebro, fase5, campo_saberes_y_pensamiento_cientifico, grado_6to_grado, materia_matematicas, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_fronterizo_e_intercultural]
id_planeacion: "F5-MAT-6TO-V05808"
campo_formativo: "Saberes y Pensamiento Científico"
materia: "Matematicas"
grado: "6º de Primaria"
nivel: "Primaria Fase 5"
tema: "Operaciones con decimales y fracciones con distinto denominador"
...
fecha_creacion: "2026-08-24T20:07:59.942Z"
---

# 📚 Proyecto Didáctico Integral: Operaciones con decimales y fracciones con distinto denominador - Variante 5808 (Fronterizo e Intercultural)
...
> **"Resuelve problemas complejos de división de decimales entre naturales y fracciones entre naturales con estrategias de equivalencia y cálculo mental de porcentajes (1%, 10%, 25%)."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Operaciones con decimales y fracciones con distinto denominador"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Fronterizo e Intercultural)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Operaciones con decimales y fracciones con distinto denominador"*.
...
- Etiquetas: #saberes_y_pensamiento_cientifico • #matematicas • #6to_grado • #steam_con_enfoque_de_indagacion_cientifica_y_robotica
