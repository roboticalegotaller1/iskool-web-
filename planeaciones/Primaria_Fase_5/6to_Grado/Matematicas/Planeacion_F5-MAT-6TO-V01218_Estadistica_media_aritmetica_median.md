---
tags: [iskool, planeacion_nem, segundo_cerebro, fase5, campo_saberes_y_pensamiento_cientifico, grado_6to_grado, materia_matematicas, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_rural_agricola]
id_planeacion: "F5-MAT-6TO-V01218"
...
fecha_creacion: "2026-08-24T20:07:52.673Z"
---

# 📚 Proyecto Didáctico Integral: Estadística: media aritmética, mediana, moda y probabilidad teórica - Variante 1218 (Rural Agrícola)
...
> **"Interpreta gráficas circulares y de barras, calculando medidas de tendencia central (media, mediana, moda) y clasificando eventos probabilísticos (seguro, imposible, probable)."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Estadística: media aritmética, mediana, moda y probabilidad teórica"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Rural Agrícola)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Estadística: media aritmética, mediana, moda y probabilidad teórica"*.
