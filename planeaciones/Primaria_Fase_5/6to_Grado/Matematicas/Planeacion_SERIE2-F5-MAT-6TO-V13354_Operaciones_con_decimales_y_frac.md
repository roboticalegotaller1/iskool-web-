---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase5, campo_saberes_y_pensamiento_cientifico, grado_6to_grado, materia_matematicas, metodologia_aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental, contexto_entorno_industrial_y_tecnologico, codiseno_2026]
id_planeacion: "SERIE2-F5-MAT-6TO-V13354"
...
contexto_comunitario: "Entorno Industrial y Tecnológico"
problematica_situada: "Economía circular, monitoreo ciudadano de la calidad del aire y gestión de residuos electrónicos."
...
fecha_creacion: "2026-08-24T21:50:13.438Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Operaciones con decimales y fracciones con distinto denominador - Modalidad Innovadora 3354 (Entorno Industrial y Tecnológico)
...
> - **Contexto Territorial:** Entorno Industrial y Tecnológico (Reto Central: *Economía circular, monitoreo ciudadano de la calidad del aire y gestión de residuos electrónicos.*)
...
> **"Resuelve problemas complejos de división de decimales entre naturales y fracciones entre naturales con estrategias de equivalencia y cálculo mental de porcentajes."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Innovador

1. **¿Cómo podemos transformar el estudio de *"Operaciones con decimales y fracciones con distinto denominador"* en una solución práctica para atender el reto de: *Economía circular, monitoreo ciudadano de la calidad del aire y gestión de residuos electrónicos.*?**
...
- **Sesión 1: Apertura del Desafío y Planteamiento Situado (50 min)**
  - *Inicio (10 min):* Presentación del caso detonador en el entorno Entorno Industrial y Tecnológico. El Prof. Israel López Ángeles contextualiza la problemática con imágenes y datos de campo.
  - *Desarrollo (30 min):* Debate abierto en asamblea escolar sobre *"Economía circular, monitoreo ciudadano de la calidad del aire y gestión de residuos electrónicos."*. Conformación de equipos de trabajo con roles asignados (coordinación, bitácora, materiales, divulgación).
...
- **Sesión 2: Mapeo Conceptual y Rescate de Saberes Previos (50 min)**
  - *Inicio (10 min):* Dinámica de preguntas cruzadas entre equipos sobre conceptos clave de *"Operaciones con decimales y fracciones con distinto denominador"*.
...
- **Sesión 4: Laboratorio Práctico / Experimentación y Prototipado (50 min)**
  ...
  - *Desarrollo (30 min):* Realización de experimentos, mediciones matemáticas, cálculos o modelado concreto enfocado en *"Operaciones con decimales y fracciones con distinto denominador"*.
...
- **Sesión 6: Bocetaje y Diseño del Producto Tangible (50 min)**
  ...
  - *Desarrollo (30 min):* Taller creativo: modelado, estructuración o redacción del primer prototipo de: *Obra de teatro guiñol y libreto dramático original sobre resolución pacífica de conflictos*.
...
> **Obra de teatro guiñol y libreto dramático original sobre resolución pacífica de conflictos** aplicado a la atención situada de: *Economía circular, monitoreo ciudadano de la calidad del aire y gestión de residuos electrónicos.*.
