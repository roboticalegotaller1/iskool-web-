---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase5, campo_saberes_y_pensamiento_cientifico, grado_6to_grado, materia_ciencias_naturales, metodologia_steam_con_robotica_pensamiento_computacional_e_indagacion, contexto_entorno_industrial_y_tecnologico, codiseno_2026]
id_planeacion: "SERIE2-F5-CIE-6TO-V17970"
...
fecha_creacion: "2026-08-24T21:50:20.212Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Sistema inmunológico, vacunas y prevención epidemiológica - Modalidad Innovadora 7970 (Entorno Industrial y Tecnológico)
...
1. **¿Cómo podemos transformar el estudio de *"Sistema inmunológico, vacunas y prevención epidemiológica"* en una solución práctica para atender el reto de: *Economía circular, monitoreo ciudadano de la calidad del aire y gestión de residuos electrónicos.*?**
...
- **Sesión 2: Mapeo Conceptual y Rescate de Saberes Previos (50 min)**
  - *Inicio (10 min):* Dinámica de preguntas cruzadas entre equipos sobre conceptos clave de *"Sistema inmunológico, vacunas y prevención epidemiológica"*.
...
- **Sesión 4: Laboratorio Práctico / Experimentación y Prototipado (50 min)**
  ...
  - *Desarrollo (30 min):* Realización de experimentos, mediciones matemáticas, cálculos o modelado concreto enfocado en *"Sistema inmunológico, vacunas y prevención epidemiológica"*.
...
- **Sesión 6: Bocetaje y Diseño del Producto Tangible (50 min)**
  ...
  - *Desarrollo (30 min):* Taller creativo: modelado, estructuración o redacción del primer prototipo de: *Campaña comunitaria multiplataforma con carteles infográficos y spots de audio*.
...
> **Campaña comunitaria multiplataforma con carteles infográficos y spots de audio** aplicado a la atención situada de: *Economía circular, monitoreo ciudadano de la calidad del aire y gestión de residuos electrónicos.*.
