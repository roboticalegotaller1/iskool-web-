---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase5, campo_saberes_y_pensamiento_cientifico, grado_6to_grado, materia_ciencias_naturales, metodologia_aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental, contexto_ecosistema_urbano_sostenible, codiseno_2026]
id_planeacion: "SERIE2-F5-CIE-6TO-V15510"
...
fecha_creacion: "2026-08-24T21:50:16.594Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Sistema inmunológico, vacunas y prevención epidemiológica - Modalidad Innovadora 5510 (Ecosistema Urbano Sostenible)
...
1. **¿Cómo podemos transformar el estudio de *"Sistema inmunológico, vacunas y prevención epidemiológica"* en una solución práctica para atender el reto de: *Implementación de huertos verticales, captación pluvial urbana y mitigación de islas de calor en escuelas metropolitanas.*?**
...
> **Campaña comunitaria multiplataforma con carteles infográficos y spots de audio** aplicado a la atención situada de: *Implementación de huertos verticales, captación pluvial urbana y mitigación de islas de calor en escuelas metropolitanas.*.
