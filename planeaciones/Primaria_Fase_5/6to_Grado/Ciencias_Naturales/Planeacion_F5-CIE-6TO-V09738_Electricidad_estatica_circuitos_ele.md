---
tags: [iskool, planeacion_nem, segundo_cerebro, fase5, campo_saberes_y_pensamiento_cientifico, grado_6to_grado, materia_ciencias_naturales, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_rural_agricola]
id_planeacion: "F5-CIE-6TO-V09738"
...
fecha_creacion: "2026-08-24T20:08:06.418Z"
---

# 📚 Proyecto Didáctico Integral: Electricidad estática, circuitos eléctricos y conductores - Variante 9738 (Rural Agrícola)
...
> **"Experimenta con cargas positivas y negativas, atracción y repulsión electrostática, construyendo circuitos eléctricos en serie y paralelo con interruptores seguros."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Electricidad estática, circuitos eléctricos y conductores"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Rural Agrícola)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Electricidad estática, circuitos eléctricos y conductores"*.
