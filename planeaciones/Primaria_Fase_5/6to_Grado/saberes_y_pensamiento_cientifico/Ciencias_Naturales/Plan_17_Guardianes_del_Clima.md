...
tema: "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica"
...
# 📚 Proyecto Didáctico Integral: Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica
...
```yaml
PDA: "Resuelve problemas situados mediante algoritmos, estimaciones, patrones numéricos y modelación geométrica aplicados a situaciones reales de "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica"."
```

### 🔗 Articulación Curricular con otros Campos Formativos:
**1. Lenguajes (Comunicación Matemática):**
- *PDA:* Comunica de forma oral y escrita explicaciones, instrucciones y procedimientos matemáticos utilizados para resolver retos vinculados a "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica".
...
Los estudiantes requieren fortalecer el cálculo mental, la comprensión del valor posicional del dinero y el desarrollo de hábitos de consumo responsable y finanzas solidarias en torno a "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica".
...
1. ¿Cómo nos ayuda el cálculo mental y el valor posicional a verificar rápidamente el costo total y el cambio en una compra comunitaria sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica"?
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica"?  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica con la vida comunitaria.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica" en tu vida diaria?
