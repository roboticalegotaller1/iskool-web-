...
```yaml
PDA: "Elabora ensayos breves, reseñas críticas y participa en debates formales sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica", sustentando sus argumentos en fuentes confiables."
```
...
- *PDA:* Aplica modelos matemáticos (porcentajes, volumen, proporcionalidad) y el método experimental para investigar fenómenos asociados a "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica".
- *Vínculo formativo:* Pensamiento probabilístico, pensamiento STEM y experimentación científica rigurosa.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Evalúa críticamente los procesos históricos y problemáticas ambientales vinculadas a "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica" a nivel nacional y global.
- *Vínculo formativo:* Conciencia histórica de México, soberanía, sustentabilidad ecológica y derechos humanos.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Lidera proyectos comunitarios colaborativos orientados a la salud integral y la equidad social en torno a "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica".
...
Necesidad de fomentar la curiosidad científica, la indagación sistemática y la aplicación de saberes escolares para entender y transformar fenómenos relacionados con "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica".
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica" de manera sencilla para que cualquiera los entienda?  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Guardianes del Clima: Efecto Invernadero, Huella de Carbono y Restauración Ecológica" en tu vida diaria?
- **📖 Libro de Texto SEP:** Nuestros Saberes 5º y 6º Grado (Págs. 152 a la 155) — *Sistemas del cuerpo humano, biodiversidad y energías limpias*
