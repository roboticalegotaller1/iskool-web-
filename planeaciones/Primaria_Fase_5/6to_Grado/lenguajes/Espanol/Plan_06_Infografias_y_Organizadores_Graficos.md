---
tags: [iskool, planeacion_nem, segundo_cerebro, boveda_curricular, nivel_primaria_alta, materia_espanol, grado_6_de_primaria]
...
tema: "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento"
...
# 📚 Proyecto Didáctico Integral: Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento
...
```yaml
PDA: "Elabora ensayos breves, reseñas críticas y participa en debates formales sobre "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento", sustentando sus argumentos en fuentes confiables."
```

### 🔗 Articulación Curricular con otros Campos Formativos:
**1. Saberes y Pensamiento Científico:**
- *PDA:* Aplica modelos matemáticos (porcentajes, volumen, proporcionalidad) y el método experimental para investigar fenómenos asociados a "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento".
...
- *PDA:* Evalúa críticamente los procesos socioambientales y las leyes que regulan problemáticas vinculadas a "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento" a nivel nacional.
...
- *PDA:* Lidera proyectos comunitarios colaborativos orientados al bienestar común y la equidad social en torno a "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento".
...
Falta de medios de difusión escolares donde los estudiantes puedan compartir investigaciones documentales, notas informativas y artículos de opinión verídicos sobre "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento".

**Propósito del Proyecto:**  
Desarrollar competencias de investigación periodística, redacción informativa y diseño editorial para socializar el tema "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento" mediante una gaceta escolar impresa y digital (Libro SEP: Proyectos Escolares).
...
1. ¿Cómo distinguimos una noticia fundamentada en hechos reales de un rumor o información falsa sobre "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento"?
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento"?  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento con la vida comunitaria.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "Infografías y Organizadores Gráficos: El Poder Visual de la Síntesis del Conocimiento" en tu vida diaria?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 6º Grado (Págs. 52 a la 54) — *Ensayos, reseñas críticas, crónicas y cartas de opinión*
