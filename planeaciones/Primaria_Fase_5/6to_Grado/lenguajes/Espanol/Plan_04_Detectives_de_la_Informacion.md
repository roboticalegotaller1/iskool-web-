...
tema: "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News"
...
# 📚 Proyecto Didáctico Integral: Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News
...
```yaml
PDA: "Elabora ensayos breves, reseñas críticas y participa en debates formales sobre "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News", sustentando sus argumentos en fuentes confiables."
```

### 🔗 Articulación Curricular con otros Campos Formativos:
**1. Saberes y Pensamiento Científico:**
- *PDA:* Aplica modelos matemáticos (porcentajes, volumen, proporcionalidad) y el método experimental para investigar fenómenos asociados a "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News".
...
- *PDA:* Evalúa críticamente los procesos socioambientales y las leyes que regulan problemáticas vinculadas a "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News" a nivel nacional.
...
- *PDA:* Lidera proyectos comunitarios colaborativos orientados al bienestar común y la equidad social en torno a "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News".
...
Falta de medios de difusión escolares donde los estudiantes puedan compartir investigaciones documentales, notas informativas y artículos de opinión verídicos sobre "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News".

**Propósito del Proyecto:**  
Desarrollar competencias de investigación periodística, redacción informativa y diseño editorial para socializar el tema "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News" mediante una gaceta escolar impresa y digital (Libro SEP: Proyectos Escolares).
...
1. ¿Cómo distinguimos una noticia fundamentada en hechos reales de un rumor o información falsa sobre "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News"?
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News"?  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News con la vida comunitaria.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "Detectives de la Información: Análisis Crítico de Medios, Sesgos y Fake News" en tu vida diaria?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 6º Grado (Págs. 52 a la 54) — *Ensayos, reseñas críticas, crónicas y cartas de opinión*
