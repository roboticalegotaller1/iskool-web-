---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase5, campo_etica_naturaleza_y_sociedades, grado_6to_grado, materia_formacion_civica, metodologia_aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental, contexto_ecosistema_urbano_sostenible, codiseno_2026]
id_planeacion: "SERIE2-F5-FOR-6TO-V16798"
...
fecha_creacion: "2026-08-24T21:50:18.523Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Democracia, transparencia y rendición de cuentas en servicios públicos - Modalidad Innovadora 6798 (Ecosistema Urbano Sostenible)
...
1. **¿Cómo podemos transformar el estudio de *"Democracia, transparencia y rendición de cuentas en servicios públicos"* en una solución práctica para atender el reto de: *Implementación de huertos verticales, captación pluvial urbana y mitigación de islas de calor en escuelas metropolitanas.*?**
...
> **Prototipo tecnológico sustentable con circuitos, sensores ambientales y materiales reciclados** aplicado a la atención situada de: *Implementación de huertos verticales, captación pluvial urbana y mitigación de islas de calor en escuelas metropolitanas.*.
...
- Etiquetas: #etica_naturaleza_y_sociedades • #formacion_civica • #6to_grado • #aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental • #codiseno_2026
