---
tags: [iskool, planeacion_nem, segundo_cerebro, fase5, campo_etica_naturaleza_y_sociedades, grado_6to_grado, materia_formacion_civica, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_rural_agricola]
id_planeacion: "F5-FOR-6TO-V02538"
campo_formativo: "Ética, Naturaleza y Sociedades"
materia: "Formacion_Civica"
...
contexto_comunitario: "Rural Agrícola"
problematica_situada: "Conservación de suelos fértiles, tecnificación de riego en milpas y preservación de semillas nativas frente al cambio climático."
...
fecha_creacion: "2026-08-24T20:07:54.707Z"
---

# 📚 Proyecto Didáctico Integral: Democracia, transparencia y rendición de cuentas en servicios públicos - Variante 2538 (Rural Agrícola)
...
> - **Asignatura / Disciplina:** Formacion Civica
> - **Metodología Sociocrítica:** STEAM con Enfoque de Indagación Científica y Robótica
> - **Contexto de Aplicación:** Rural Agrícola (Enfoque: *Conservación de suelos fértiles, tecnificación de riego en milpas y preservación de semillas nativas frente al cambio climático.*)
...
> **"Comprende los principios del gobierno democrático representativo y federal, valorando el derecho a la información pública, la transparencia y el combate a la corrupción."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Democracia, transparencia y rendición de cuentas en servicios públicos"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Rural Agrícola)?**
...
- **Sesión 1: Apertura y Encuadre Cognitivo (50 min)**
  - *Inicio (10 min):* Presentación de la situación problemática en el contexto Rural Agrícola. El docente Prof. Israel López Ángeles plantea las preguntas detonadoras.
  - *Desarrollo (30 min):* Lluvia de ideas estructurada y debate guiado sobre experiencias comunitarias vinculadas a: *Conservación de suelos fértiles, tecnificación de riego en milpas y preservación de semillas nativas frente al cambio climático.*. Organización de equipos de trabajo colaborativo heterogéneos.
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Democracia, transparencia y rendición de cuentas en servicios públicos"*.
...
| :--- | :--- | :--- | :--- |
| **Dominio del PDA Oficial** | Demuestra comprensión profunda y aplicación autónoma del contenido *"Democracia, transparencia y rendición de cuentas en servicios públicos"*, argumentando con solvencia técnica. | Comprende las ideas esenciales del PDA y las aplica correctamente con guía del docente. | Muestra nociones iniciales del tema pero requiere apoyo continuo para estructurar sus explicaciones. |
| **Vinculación Situada (Rural Agrícola)** | Conecta de forma crítica y original el aprendizaje con la problemática *"Conservación de suelos fértiles, tecnificación de riego en milpas y preservación de semillas nativas frente al cambio climático."*, proponiendo mejoras viables. | Relaciona adecuadamente el tema con situaciones de su entorno escolar o familiar. | Describe el contexto de forma superficial sin conectar plenamente con el tema de estudio. |
...
> **Dramatización teatral comunitaria y lectura de atril ante padres de familia** enfocado en la resolución situada de: *Conservación de suelos fértiles, tecnificación de riego en milpas y preservación de semillas nativas frente al cambio climático.*.
...
- Etiquetas: #etica_naturaleza_y_sociedades • #formacion_civica • #6to_grado • #steam_con_enfoque_de_indagacion_cientifica_y_robotica
