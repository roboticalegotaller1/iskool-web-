---
tags: [iskool, planeacion_nem, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_4to_grado, materia_ciencias_naturales, metodologia_aprendizaje_basado_en_problemas_abp_, contexto_fronterizo_e_intercultural]
id_planeacion: "F4-CIE-4TO-V09288"
...
fecha_creacion: "2026-08-24T20:07:49.673Z"
---

# 📚 Proyecto Didáctico Integral: Estructura del sistema digestivo y su relación con el circulatorio - Variante 9288 (Fronterizo e Intercultural)
...
> **"Identifica la ruta de los alimentos en la ingestión, digestión, absorción y transporte de nutrimentos, experimentando con la saliva y jugos digestivos (ácidos)."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Estructura del sistema digestivo y su relación con el circulatorio"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Fronterizo e Intercultural)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Estructura del sistema digestivo y su relación con el circulatorio"*.
...
- Etiquetas: #saberes_y_pensamiento_cientifico • #ciencias_naturales • #4to_grado • #aprendizaje_basado_en_problemas_abp_
