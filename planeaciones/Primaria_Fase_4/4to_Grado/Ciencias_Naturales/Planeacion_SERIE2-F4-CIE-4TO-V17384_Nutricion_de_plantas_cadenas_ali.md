---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_4to_grado, materia_ciencias_naturales, metodologia_aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental, contexto_pueblo_originario_y_bilingue_de_tradicion_ancestral, codiseno_2026]
id_planeacion: "SERIE2-F4-CIE-4TO-V17384"
...
fecha_creacion: "2026-08-24T21:50:04.714Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Nutrición de plantas, cadenas alimentarias y ecosistemas - Modalidad Innovadora 7384 (Pueblo Originario y Bilingüe de Tradición Ancestral)
...
1. **¿Cómo podemos transformar el estudio de *"Nutrición de plantas, cadenas alimentarias y ecosistemas"* en una solución práctica para atender el reto de: *Revitalización de la lengua originaria, preservación de la medicina tradicional y fortalecimiento del tequio.*?**
...
- **Sesión 2: Mapeo Conceptual y Rescate de Saberes Previos (50 min)**
  - *Inicio (10 min):* Dinámica de preguntas cruzadas entre equipos sobre conceptos clave de *"Nutrición de plantas, cadenas alimentarias y ecosistemas"*.
...
- **Sesión 4: Laboratorio Práctico / Experimentación y Prototipado (50 min)**
  ...
  - *Desarrollo (30 min):* Realización de experimentos, mediciones matemáticas, cálculos o modelado concreto enfocado en *"Nutrición de plantas, cadenas alimentarias y ecosistemas"*.
