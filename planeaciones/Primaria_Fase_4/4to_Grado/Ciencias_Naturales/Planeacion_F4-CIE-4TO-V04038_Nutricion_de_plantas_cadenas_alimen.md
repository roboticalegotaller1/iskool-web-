---
tags: [iskool, planeacion_nem, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_4to_grado, materia_ciencias_naturales, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_zona_montanosa_y_boscosa]
id_planeacion: "F4-CIE-4TO-V04038"
campo_formativo: "Saberes y Pensamiento Científico"
materia: "Ciencias_Naturales"
grado: "4º de Primaria"
nivel: "Primaria Fase 4"
tema: "Nutrición de plantas, cadenas alimentarias y ecosistemas"
...
fecha_creacion: "2026-08-24T20:07:41.230Z"
---

# 📚 Proyecto Didáctico Integral: Nutrición de plantas, cadenas alimentarias y ecosistemas - Variante 4038 (Zona Montañosa y Boscosa)
...
> **"Explica la nutrición vegetal (fotosíntesis con luz solar, agua y CO2) y describe cadenas alimentarias estructuradas en productores, consumidores y descomponedores."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Nutrición de plantas, cadenas alimentarias y ecosistemas"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Zona Montañosa y Boscosa)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Nutrición de plantas, cadenas alimentarias y ecosistemas"*.
