---
tags: [iskool, planeacion_nem, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_4to_grado, materia_ciencias_naturales, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_altiplano_central]
id_planeacion: "F4-CIE-4TO-V07367"
campo_formativo: "Saberes y Pensamiento Científico"
materia: "Ciencias_Naturales"
grado: "4º de Primaria"
nivel: "Primaria Fase 4"
tema: "Ciclo del agua, cambios de estado y variación de temperatura"
...
fecha_creacion: "2026-08-24T20:07:46.660Z"
---

# 📚 Proyecto Didáctico Integral: Ciclo del agua, cambios de estado y variación de temperatura - Variante 7367 (Altiplano Central)
...
> **"Describe los cambios de estado del agua (evaporación, condensación, solidificación, fusión) relacionándolos con la temperatura y el diseño de termómetros precisos."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Ciclo del agua, cambios de estado y variación de temperatura"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Altiplano Central)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Ciclo del agua, cambios de estado y variación de temperatura"*.
