...
```yaml
PDA: "Elabora ensayos breves, reseñas críticas y participa en debates formales sobre 'Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela', sustentando sus argumentos en fuentes confiables."
```
...
- *PDA:* Aplica modelos matemáticos (porcentajes, volumen, proporcionalidad) y el método experimental para investigar fenómenos asociados a "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela".
- *Vínculo formativo:* Pensamiento probabilístico, pensamiento STEM y experimentación científica rigurosa.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Evalúa críticamente los procesos históricos y problemáticas ambientales vinculadas a "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela" a nivel nacional y global.
- *Vínculo formativo:* Conciencia histórica de México, soberanía, sustentabilidad ecológica y derechos humanos.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Lidera proyectos comunitarios colaborativos orientados a la salud integral y la equidad social en torno a "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela".
...
Falta de medios impresos o digitales escolares donde las niñas y niños puedan comunicar hallazgos, opiniones fundamentadas y propuestas de mejora sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela" para la comunidad.

**Propósito del Proyecto:**
Desarrollar habilidades de investigación documental, redacción de textos informativos y argumentativos, y diseño editorial para socializar el tema de "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela".
...
- **⏱️ Inicio (10 min):**
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**
...
- **❓ Preguntas Clave de la Sesión:**
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela"?
...
- **❓ Preguntas Clave de la Sesión:**
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela"?
...
- **🔬 Desarrollo (30 min):**
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela".
- **🌟 Cierre (10 min):**
...
- **❓ Preguntas Clave de la Sesión:**
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela"?
...
- **❓ Preguntas Clave de la Sesión:**
  1. ¿Cómo podemos explicar conceptos de "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela" de manera sencilla para que cualquiera los entienda?
...
- **❓ Preguntas Clave de la Sesión:**
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela" en tu vida diaria?
- **📖 Libro de Texto SEP:** Proyectos Escolares 6º Grado (Págs. 100 a la 102) — *Periódico escolar digital y mesas redondas*
