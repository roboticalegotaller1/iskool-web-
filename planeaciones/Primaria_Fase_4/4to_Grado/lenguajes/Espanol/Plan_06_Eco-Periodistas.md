...
tema: "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela"
...
# 📚 Proyecto Didáctico Integral: Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela
...
Falta de medios de difusión escolares donde los estudiantes puedan compartir investigaciones documentales, notas informativas y artículos de opinión verídicos sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela".

**Propósito del Proyecto:**  
Desarrollar competencias de investigación periodística, redacción informativa y diseño editorial para socializar el tema "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela" mediante una gaceta escolar impresa y digital (Libro SEP: Proyectos Escolares).
...
1. ¿Cómo distinguimos una noticia fundamentada en hechos reales de un rumor o información falsa sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela"?
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela"?  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela con la vida comunitaria.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "Eco-Periodistas: Textos Expositivos de Problema-Solución en la Escuela" en tu vida diaria?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 6º Grado (Págs. 52 a la 54) — *Ensayos, reseñas críticas, crónicas y cartas de opinión*
