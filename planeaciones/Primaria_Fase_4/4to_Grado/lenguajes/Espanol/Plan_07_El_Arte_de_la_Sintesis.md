...
```yaml
PDA: "Comprende, sintetiza y redacta textos expositivos, informativos y esquemas visuales sobre "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos" para divulgar en el aula y la escuela."
```
...
- *PDA:* Resuelve situaciones problemáticas vinculadas a "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos" mediante operaciones básicas, fracciones, cálculo de áreas y experimentos sencillos.
- *Vínculo formativo:* Razonamiento lógico-matemático, análisis de datos en tablas y pensamiento indagatorio.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Analiza la diversidad natural y sociocultural de su entidad en torno a "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos", valorando la justicia y los derechos de todos.
- *Vínculo formativo:* Conocimiento del entorno regional, cuidado del medio ambiente y participación cívica.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Diseña estrategias cooperativas para prevenir riesgos y resolver conflictos escolares al trabajar proyectos sobre "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos".
...
Falta de medios impresos o digitales escolares donde las niñas y niños puedan comunicar hallazgos, opiniones fundamentadas y propuestas de mejora sobre "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos" para la comunidad.

**Propósito del Proyecto:**  
Desarrollar habilidades de investigación documental, redacción de textos informativos y argumentativos, y diseño editorial para socializar el tema de "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos".
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos"?  
  2. ¿Qué problema podríamos resolver en la escuela o en casa si dominamos este conocimiento?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 3º y 4º Grado (Págs. 44 a la 47) — *Lecturas de divulgación, leyendas y textos expositivos*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos"?  
  2. ¿Cómo se relacionan estas definiciones con los ejemplos que analizamos en la sesión anterior?
- **📖 Libro de Texto SEP:** Proyectos de Aula 4º Grado (Págs. 95 a la 98) — *Elaboración de revistas científicas, correspondencia y debates*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos".
- **🌟 Cierre (10 min):**  
...
- **📖 Libro de Texto SEP:** Nuestros Saberes 3º y 4º Grado (Págs. 36 a la 39) — *Estructura textual, ortografía y redacción formal*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos"?  
  2. ¿Cuál es el método más claro para explicar tu respuesta a los demás?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 3º y 4º Grado (Págs. 53 a la 56) — *Lecturas de divulgación, leyendas y textos expositivos*
...
- **📖 Libro de Texto SEP:** Proyectos de Aula 4º Grado (Págs. 104 a la 107) — *Elaboración de revistas científicas, correspondencia y debates*
...
- **📖 Libro de Texto SEP:** Nuestros Saberes 3º y 4º Grado (Págs. 45 a la 48) — *Estructura textual, ortografía y redacción formal*
...
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 3º y 4º Grado (Págs. 62 a la 65) — *Lecturas de divulgación, leyendas y textos expositivos*
...
- **📖 Libro de Texto SEP:** Proyectos de Aula 4º Grado (Págs. 113 a la 116) — *Elaboración de revistas científicas, correspondencia y debates*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos" de manera sencilla para que cualquiera los entienda?  
  2. ¿Qué tono de voz y postura corporal transmiten seguridad y entusiasmo en nuestra presentación?
- **📖 Libro de Texto SEP:** Nuestros Saberes 3º y 4º Grado (Págs. 54 a la 57) — *Estructura textual, ortografía y redacción formal*
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "El Arte de la Síntesis: Ideas Principales, Paráfrasis y Gráficos Informativos" en tu vida diaria?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 3º y 4º Grado (Págs. 71 a la 74) — *Lecturas de divulgación, leyendas y textos expositivos*
