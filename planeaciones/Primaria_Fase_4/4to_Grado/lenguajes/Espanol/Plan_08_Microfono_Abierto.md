...
- *PDA:* Observa, formula hipótesis y experimenta para explicar fenómenos naturales y propiedades de la materia en torno a "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial".
...
Elevada incidencia de consumo de alimentos ultraprocesados, hábitos sedentarios y falta de información accesible sobre el cuidado integral del cuerpo humano en torno a "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial".
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial" en tu vida diaria?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 4º Grado (Págs. 44 a la 46) — *Lecturas de divulgación, leyendas y textos expositivos*
...
| :--- | :--- | :--- | :--- |
| **Comprensión Nutricional y Fisiológica del Cuerpo** | Explica con precisión la función de los nutrientes, los riesgos del consumo excesivo de azúcares y grasas, y la fisiología del cuerpo humano frente a "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial". | Identifica los grupos del Plato del Bien Comer y propone opciones de menús balanceados. | Confunde los grupos nutrimentales o desconoce la función básica de los órganos. |
