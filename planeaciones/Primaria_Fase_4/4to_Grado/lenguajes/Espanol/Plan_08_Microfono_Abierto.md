...
tema: "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial"
...
# 📚 Proyecto Didáctico Integral: Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial
...
```yaml
PDA: "Comprende, sintetiza y redacta textos expositivos, informativos y esquemas visuales sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial" para divulgar en el aula y la escuela."
```
...
- *PDA:* Resuelve situaciones problemáticas vinculadas a "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial" mediante operaciones básicas, fracciones, cálculo de áreas y experimentos sencillos.
- *Vínculo formativo:* Razonamiento lógico-matemático, análisis de datos en tablas y pensamiento indagatorio.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Analiza la diversidad natural y sociocultural de su entidad en torno a "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial", valorando la justicia y los derechos de todos.
- *Vínculo formativo:* Conocimiento del entorno regional, cuidado del medio ambiente y participación cívica.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Diseña estrategias cooperativas para prevenir riesgos y resolver conflictos escolares al trabajar proyectos sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial".
...
Falta de medios impresos o digitales escolares donde las niñas y niños puedan comunicar hallazgos, opiniones fundamentadas y propuestas de mejora sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial" para la comunidad.

**Propósito del Proyecto:**  
Desarrollar habilidades de investigación documental, redacción de textos informativos y argumentativos, y diseño editorial para socializar el tema de "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial"?  
  2. ¿Qué problema podríamos resolver en la escuela o en casa si dominamos este conocimiento?
- **📖 Libro de Texto SEP:** Nuestros Saberes 3º y 4º Grado (Págs. 29 a la 32) — *Estructura textual, ortografía y redacción formal*
- **📦 Materiales:** Papel bond blanco, Plumones de colores, Material concreto o interactivo, Cuaderno del alumno
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial"?  
  2. ¿Cómo se relacionan estas definiciones con los ejemplos que analizamos en la sesión anterior?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 3º y 4º Grado (Págs. 46 a la 49) — *Lecturas de divulgación, leyendas y textos expositivos*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial".
- **🌟 Cierre (10 min):**  
...
- **📖 Libro de Texto SEP:** Proyectos de Aula 4º Grado (Págs. 97 a la 100) — *Elaboración de revistas científicas, correspondencia y debates*
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial"?  
  2. ¿Cuál es el método más claro para explicar tu respuesta a los demás?
- **📖 Libro de Texto SEP:** Nuestros Saberes 3º y 4º Grado (Págs. 38 a la 41) — *Estructura textual, ortografía y redacción formal*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial"?  
  2. ¿Cómo organizamos los datos para que cualquier persona de la comunidad los entienda con claridad?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 3º y 4º Grado (Págs. 55 a la 58) — *Lecturas de divulgación, leyendas y textos expositivos*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📖 Libro de Texto SEP:** Proyectos de Aula 4º Grado (Págs. 106 a la 109) — *Elaboración de revistas científicas, correspondencia y debates*
- **📦 Materiales:** Material artístico / cartulinas, Textos informativos complementarios, Plumones
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial con la vida comunitaria.
...
- **📖 Libro de Texto SEP:** Nuestros Saberes 3º y 4º Grado (Págs. 47 a la 50) — *Estructura textual, ortografía y redacción formal*
...
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 3º y 4º Grado (Págs. 64 a la 67) — *Lecturas de divulgación, leyendas y textos expositivos*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial" de manera sencilla para que cualquiera los entienda?  
  2. ¿Qué tono de voz y postura corporal transmiten seguridad y entusiasmo en nuestra presentación?
- **📖 Libro de Texto SEP:** Proyectos de Aula 4º Grado (Págs. 115 a la 118) — *Elaboración de revistas científicas, correspondencia y debates*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Micrófono Abierto: Planificación, Preguntas Abiertas y Reporte de Entrevista Testimonial" en tu vida diaria?
- **📖 Libro de Texto SEP:** Nuestros Saberes 3º y 4º Grado (Págs. 56 a la 59) — *Estructura textual, ortografía y redacción formal*
