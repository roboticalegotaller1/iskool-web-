---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase4, campo_lenguajes, grado_4to_grado, materia_espanol, metodologia_aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental, contexto_comunidad_rural_agroecologica, codiseno_2026]
id_planeacion: "SERIE2-F4-ESP-4TO-V12383"
...
fecha_creacion: "2026-08-24T21:49:57.132Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Descripción de personas, lugares, hechos y procesos - Modalidad Innovadora 2383 (Comunidad Rural Agroecológica)
...
> **"Planea y redacta descripciones lógicas de procesos comunitarios utilizando conectores secuenciales (en primer lugar, posteriormente, finalmente) y temporales (simultáneamente, antes, después)."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Innovador

1. **¿Cómo podemos transformar el estudio de *"Descripción de personas, lugares, hechos y procesos"* en una solución práctica para atender el reto de: *Transición hacia biofertilizantes, conservación de maíces nativos y rescate de técnicas milperas sustentables.*?**
...
- **Sesión 2: Mapeo Conceptual y Rescate de Saberes Previos (50 min)**
  - *Inicio (10 min):* Dinámica de preguntas cruzadas entre equipos sobre conceptos clave de *"Descripción de personas, lugares, hechos y procesos"*.
...
- **Sesión 4: Laboratorio Práctico / Experimentación y Prototipado (50 min)**
  ...
  - *Desarrollo (30 min):* Realización de experimentos, mediciones matemáticas, cálculos o modelado concreto enfocado en *"Descripción de personas, lugares, hechos y procesos"*.
...
- Etiquetas: #lenguajes • #espanol • #4to_grado • #aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental • #codiseno_2026
