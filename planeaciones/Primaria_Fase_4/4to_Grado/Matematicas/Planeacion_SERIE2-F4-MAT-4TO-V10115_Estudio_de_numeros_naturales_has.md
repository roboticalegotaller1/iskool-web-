---
tags: [iskool, planeacion_nem, segundo_cerebro, boveda_curricular, nivel_primaria_alta, materia_matematicas, grado_4_de_primaria]
...
tema: "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos"
...
# 📚 Proyecto Didáctico Integral: � Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos
...
Los estudiantes requieren fortalecer el cálculo mental, la comprensión del valor posicional del dinero y el desarrollo de hábitos de consumo responsable y finanzas solidarias en torno a "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos".
...
1. ¿Cómo nos ayuda el cálculo mental y el valor posicional a verificar rápidamente el costo total y el cambio en una compra comunitaria sobre "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos"?
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre � Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos"?  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula � Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos con la vida comunitaria.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "� Proyecto de Codiseño Comunitario: Estudio de números naturales hasta cinco cifras y decimales hasta centésimos" en tu vida diaria?
- **📖 Libro de Texto SEP:** Nuestros Saberes 6º Grado (Págs. 86 a la 88) — *Geometría del círculo, valor aproximado de Pi, volumen y plano cartesiano*
