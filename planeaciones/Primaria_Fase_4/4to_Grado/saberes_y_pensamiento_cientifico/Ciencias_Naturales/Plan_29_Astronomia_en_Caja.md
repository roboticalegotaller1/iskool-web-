...
```yaml
PDA: "Comprende, sintetiza y redacta textos expositivos, informativos y esquemas visuales sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales" para divulgar en el aula y la escuela."
```
...
- *PDA:* Resuelve situaciones problemáticas vinculadas a "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales" mediante operaciones básicas, fracciones, cálculo de áreas y experimentos sencillos.
- *Vínculo formativo:* Razonamiento lógico-matemático, análisis de datos en tablas y pensamiento indagatorio.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Analiza la diversidad natural y sociocultural de su entidad en torno a "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales", valorando la justicia y los derechos de todos.
- *Vínculo formativo:* Conocimiento del entorno regional, cuidado del medio ambiente y participación cívica.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Diseña estrategias cooperativas para prevenir riesgos y resolver conflictos escolares al trabajar proyectos sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales".
...
Necesidad de fomentar la curiosidad científica, la indagación sistemática y la aplicación de saberes escolares para entender y transformar fenómenos relacionados con "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales".
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales" de manera sencilla para que cualquiera los entienda?  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales" en tu vida diaria?
