...
tema: "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales"
...
# 📚 Proyecto Didáctico Integral: Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales
...
```yaml
PDA: "Plantea preguntas, formula hipótesis tentativas y registra observaciones empíricas sistemáticas sobre los componentes y fenómenos de "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales" en su entorno escolar y comunitario."
```

### 🔗 Articulación Curricular con otros Campos Formativos:
**1. Lenguajes (Primaria Media - Fase 4):**
- *PDA:* Indaga en diversas fuentes informativas, sintetiza ideas clave y redacta textos explicativos e instructivos estructurados sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales" empleando conectores lógicos y signos de puntuación.
...
- *PDA:* Examina la relevancia y consecuencias sociales o ambientales de "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales" en la vida cotidiana de su entidad federativa, proponiendo acciones orientadas al bien común.
...
- *PDA:* Colabora en equipos escolares mediante acuerdos consensuados, diálogo empático y distribución equitativa de roles para desarrollar propuestas de acción comunitaria sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales".
...
Deterioro de las áreas verdes y escasa cultura sobre la conservación de la biodiversidad, el ciclo del agua y el manejo sustentable de recursos relacionados con "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales" en la comunidad escolar.
...
1. ¿Qué factores ambientales (agua, luz, temperatura, tipo de suelo) determinan el equilibrio biológico en los ecosistemas de nuestra entidad sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales"?
...
3. ¿Qué acciones concretas y medibles podemos implementar en la escuela para filtrar el agua, separar residuos o proteger la biodiversidad en "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales"?

---

## 📅 IV. Secuencia Didáctica Completa (Dosificación en 10 Bloques de 50 Minutos)

### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales"?  
  2. ¿Qué reto o problema podemos resolver en la escuela si investigamos este tema en equipo?
- **📖 Libro de Texto SEP:** Nuestros Saberes 4º Grado (Págs. 94 a la 96) — *Ecosistemas, cadenas alimentarias, estados del agua y nutrición*
- **📦 Materiales:** Papel bond blanco, Plumones de colores, Material concreto o interactivo, Cuaderno del alumno
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales"?  
  2. ¿Cómo se relacionan estas lecturas con los ejemplos que observamos en nuestra comunidad?
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 3º Grado (Págs. 144 a la 146) — *Filtros de agua y composta escolar sustentable*
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales"?  
  2. ¿Cuál es la forma más clara de explicar nuestro razonamiento a los demás compañeros?
- **📖 Libro de Texto SEP:** Proyectos Escolares 4º Grado (Págs. 160 a la 162) — *Propiedades físicas de los materiales y mezclas del entorno*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales"?  
  2. ¿Cómo organizamos los datos para que cualquier persona de la comunidad los entienda con claridad?
- **📖 Libro de Texto SEP:** Nuestros Saberes 4º Grado (Págs. 100 a la 102) — *Ecosistemas, cadenas alimentarias, estados del agua y nutrición*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales"?  
  2. ¿Cómo organizamos los datos para que cualquier persona de la comunidad los entienda con claridad?
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 3º Grado (Págs. 150 a la 152) — *Filtros de agua y composta escolar sustentable*
- **📦 Materiales:** Cartulinas o pliegos de papel, Colores y reglas, Borradores de trabajo
- **📄 Entregable de la Sesión:** 📄 Entregable Intermedio: Primer borrador estructurado del producto del proyecto con datos organizados.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📖 Libro de Texto SEP:** Proyectos Escolares 4º Grado (Págs. 166 a la 168) — *Propiedades físicas de los materiales y mezclas del entorno*
- **📦 Materiales:** Material artístico / cartulinas, Textos informativos complementarios, Plumones
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales con la vida comunitaria.
...
- **📖 Libro de Texto SEP:** Nuestros Saberes 4º Grado (Págs. 106 a la 108) — *Ecosistemas, cadenas alimentarias, estados del agua y nutrición*
...
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 3º Grado (Págs. 156 a la 158) — *Filtros de agua y composta escolar sustentable*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué cambios hicimos en nuestro producto que lo hicieron más claro y completo?  
  2. ¿Nos sentimos orgullosos del trabajo que vamos a presentar a la comunidad escolar?
- **📖 Libro de Texto SEP:** Proyectos Escolares 4º Grado (Págs. 156 a la 158) — *Propiedades físicas de los materiales y mezclas del entorno*
- **📦 Materiales:** Materiales finales de exposición (cartulinas, modelos, maquetas, sobres, trípticos), Tijeras, pegamento, plumones
- **📄 Entregable de la Sesión:** 📄 Producto Final Terminado: Versión definitiva del proyecto didáctico lista para su exposición comunitaria.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales" en tu vida diaria?
- **📖 Libro de Texto SEP:** Nuestros Saberes 4º Grado (Págs. 98 a la 100) — *Ecosistemas, cadenas alimentarias, estados del agua y nutrición*
...
| :--- | :--- | :--- | :--- |
| **Indagación Científica y Registro de Observaciones** | Registra datos de forma sistemática en bitácoras de campo, formula hipótesis fundamentadas y explica con precisión los ciclos biológicos vinculados a "Astronomía en Caja: Simulador de Eclipses, Fases Lunares y Sombras Espaciales". | Completa su registro de observaciones y describe los fenómenos naturales apoyándose en el libro SEP. | El registro de datos es incompleto o no explica las causas de los fenómenos observados. |
