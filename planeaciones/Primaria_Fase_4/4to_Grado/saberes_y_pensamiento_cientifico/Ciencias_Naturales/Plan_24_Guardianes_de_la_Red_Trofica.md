...
tema: "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis"
...
# 📚 Proyecto Didáctico Integral: Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis
...
```yaml
PDA: "Plantea preguntas, formula hipótesis tentativas y registra observaciones empíricas sistemáticas sobre los componentes y fenómenos de "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis" en su entorno escolar y comunitario."
```

### 🔗 Articulación Curricular con otros Campos Formativos:
**1. Lenguajes (Primaria Media - Fase 4):**
- *PDA:* Indaga en diversas fuentes informativas, sintetiza ideas clave y redacta textos explicativos e instructivos estructurados sobre "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis" empleando conectores lógicos y signos de puntuación.
...
- *PDA:* Examina la relevancia y consecuencias sociales o ambientales de "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis" en la vida cotidiana de su entidad federativa, proponiendo acciones orientadas al bien común.
...
- *PDA:* Colabora en equipos escolares mediante acuerdos consensuados, diálogo empático y distribución equitativa de roles para desarrollar propuestas de acción comunitaria sobre "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis".
...
Deterioro de las áreas verdes y escasa cultura sobre la conservación de la biodiversidad, el ciclo del agua y el manejo sustentable de recursos relacionados con "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis" en la comunidad escolar.
...
1. ¿Qué factores ambientales (agua, luz, temperatura, tipo de suelo) determinan el equilibrio biológico en los ecosistemas de nuestra entidad sobre "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis"?
...
3. ¿Qué acciones concretas y medibles podemos implementar en la escuela para filtrar el agua, separar residuos o proteger la biodiversidad en "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis"?

---

## 📅 IV. Secuencia Didáctica Completa (Dosificación en 10 Bloques de 50 Minutos)

### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis"?  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis con la vida comunitaria.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis" en tu vida diaria?
...
| :--- | :--- | :--- | :--- |
| **Indagación Científica y Registro de Observaciones** | Registra datos de forma sistemática en bitácoras de campo, formula hipótesis fundamentadas y explica con precisión los ciclos biológicos vinculados a "Guardianes de la Red Trófica: Productores, Consumidores y Fotosíntesis". | Completa su registro de observaciones y describe los fenómenos naturales apoyándose en el libro SEP. | El registro de datos es incompleto o no explica las causas de los fenómenos observados. |
