---
tags: [iskool, planeacion_nem, segundo_cerebro, boveda_curricular, nivel_primaria_media, materia_vida_saludable, grado_3_de_primaria]
...
tema: "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares"
...
# 📚 Proyecto Didáctico Integral: Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares
...
```yaml
PDA: "Colabora en equipos escolares mediante acuerdos consensuados, diálogo empático y distribución equitativa de roles para desarrollar propuestas de acción comunitaria sobre "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares"."
```

### 🔗 Articulación Curricular con otros Campos Formativos:
**1. Lenguajes (Primaria Media - Fase 4):**
- *PDA:* Indaga en diversas fuentes informativas, sintetiza ideas clave y redacta textos explicativos e instructivos estructurados sobre "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares" empleando conectores lógicos y signos de puntuación.
- *Vínculo formativo:* Comprensión lectora analítica, redacción estructurada en párrafos y divulgación de saberes.

**2. Saberes y Pensamiento Científico:**
- *PDA:* Plantea preguntas, formula hipótesis tentativas y registra observaciones empíricas sistemáticas sobre los componentes y fenómenos de "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares" en su entorno escolar y comunitario.
- *Vínculo formativo:* Indagación científica escolar, pensamiento lógico y registro riguroso de evidencias empíricas.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Examina la relevancia y consecuencias sociales o ambientales de "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares" en la vida cotidiana de su entidad federativa, proponiendo acciones orientadas al bien común.
...
Elevada incidencia de consumo de alimentos ultraprocesados, hábitos sedentarios y falta de información accesible sobre el cuidado integral del cuerpo humano en torno a "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares"?  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares con la vida comunitaria.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares" en tu vida diaria?
- **📖 Libro de Texto SEP:** Nuestros Saberes 4º Grado (Págs. 70 a la 72) — *Saberes integrados, identidad cultural y formación ética*
...
| :--- | :--- | :--- | :--- |
| **Comprensión Nutricional y Fisiológica del Cuerpo** | Explica con precisión la función de los nutrientes, los riesgos del consumo excesivo de azúcares y grasas, y la fisiología del cuerpo humano frente a "Lonchera Sana: Hidratación Inteligente, Frutas de Temporada y Cero Azúcares". | Identifica los grupos del Plato del Bien Comer y propone opciones de menús balanceados. | Confunde los grupos nutrimentales o desconoce la función básica de los órganos. |
