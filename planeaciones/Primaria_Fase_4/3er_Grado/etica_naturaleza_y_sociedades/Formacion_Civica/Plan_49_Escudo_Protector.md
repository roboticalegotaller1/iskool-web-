...
tema: "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda"
...
# 📚 Proyecto Didáctico Integral: Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda
...
```yaml
PDA: "Comprende, sintetiza y redacta textos expositivos, informativos y esquemas visuales sobre "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda" para divulgar en el aula y la escuela."
```
...
- *PDA:* Resuelve situaciones problemáticas vinculadas a "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda" mediante operaciones básicas, fracciones, cálculo de áreas y experimentos sencillos.
- *Vínculo formativo:* Razonamiento lógico-matemático, análisis de datos en tablas y pensamiento indagatorio.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Analiza la diversidad natural y sociocultural de su entidad en torno a "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda", valorando la justicia y los derechos de todos.
- *Vínculo formativo:* Conocimiento del entorno regional, cuidado del medio ambiente y participación cívica.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Diseña estrategias cooperativas para prevenir riesgos y resolver conflictos escolares al trabajar proyectos sobre "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda".
...
Necesidad de fomentar la curiosidad científica, la indagación sistemática y la aplicación de saberes escolares para entender y transformar fenómenos relacionados con "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda".
- **🌟 Cierre (10 min):**  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda con la vida comunitaria.
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda" de manera sencilla para que cualquiera los entienda?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Escudo Protector: Derecho a la Integridad Física, Emocional y Redes de Ayuda" en tu vida diaria?
