---
tags: [iskool, planeacion_nem, segundo_cerebro, fase4, campo_lenguajes, grado_3er_grado, materia_espanol, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_fronterizo_e_intercultural]
id_planeacion: "F4-ESP-3ER-V07128"
...
metodologia: "STEAM con Enfoque de Indagación Científica y Robótica"
contexto_comunitario: "Fronterizo e Intercultural"
problematica_situada: "Integración comunitaria de estudiantes migrantes, diálogo intercultural y cultura de paz en zonas de alta movilidad humana."
...
fecha_creacion: "2026-08-24T20:07:46.313Z"
---

# 📚 Proyecto Didáctico Integral: Comprensión y producción de textos expositivos (problema-solución, comparación-contraste, causa-consecuencia) - Variante 7128 (Fronterizo e Intercultural)
...
> - **Metodología Sociocrítica:** STEAM con Enfoque de Indagación Científica y Robótica
> - **Contexto de Aplicación:** Fronterizo e Intercultural (Enfoque: *Integración comunitaria de estudiantes migrantes, diálogo intercultural y cultura de paz en zonas de alta movilidad humana.*)
> - **Ejes Articuladores SEP:** Pensamiento Crítico • Apropiación de las Culturas a través de la Lectura y la Escritura
...
> **"Recurre a soportes con textos expositivos y diccionarios, comprendiendo estructuras de problema-solución y causa-consecuencia para redactar textos informativos del entorno."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Comprensión y producción de textos expositivos (problema-solución, comparación-contraste, causa-consecuencia)"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Fronterizo e Intercultural)?**
...
- **Sesión 1: Apertura y Encuadre Cognitivo (50 min)**
  - *Inicio (10 min):* Presentación de la situación problemática en el contexto Fronterizo e Intercultural. El docente Prof. Israel López Ángeles plantea las preguntas detonadoras.
  - *Desarrollo (30 min):* Lluvia de ideas estructurada y debate guiado sobre experiencias comunitarias vinculadas a: *Integración comunitaria de estudiantes migrantes, diálogo intercultural y cultura de paz en zonas de alta movilidad humana.*. Organización de equipos de trabajo colaborativo heterogéneos.
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Comprensión y producción de textos expositivos (problema-solución, comparación-contraste, causa-consecuencia)"*.
...
- **Sesión 5: Discusión y Vinculación Interdisciplinar (50 min)**
  - *Inicio (10 min):* Conexión del tema con los ejes articuladores: *Pensamiento Crítico, Apropiación de las Culturas a través de la Lectura y la Escritura*.
...
- **Sesión 6: Diseño y Bocetaje del Entregable (50 min)**
  ...
  - *Desarrollo (30 min):* Taller creativo en equipos: diseño del primer prototipo o borrador de: *Dramatización teatral comunitaria y lectura de atril ante padres de familia*.
...
| :--- | :--- | :--- | :--- |
| **Dominio del PDA Oficial** | Demuestra comprensión profunda y aplicación autónoma del contenido *"Comprensión y producción de textos expositivos (problema-solución, comparación-contraste, causa-consecuencia)"*, argumentando con solvencia técnica. | Comprende las ideas esenciales del PDA y las aplica correctamente con guía del docente. | Muestra nociones iniciales del tema pero requiere apoyo continuo para estructurar sus explicaciones. |
| **Vinculación Situada (Fronterizo e Intercultural)** | Conecta de forma crítica y original el aprendizaje con la problemática *"Integración comunitaria de estudiantes migrantes, diálogo intercultural y cultura de paz en zonas de alta movilidad humana."*, proponiendo mejoras viables. | Relaciona adecuadamente el tema con situaciones de su entorno escolar o familiar. | Describe el contexto de forma superficial sin conectar plenamente con el tema de estudio. |
| **Calidad del Entregable Tangible** | El producto (*Dramatización teatral comunitaria y lectura de atril ante padres de familia*) es impecable, creativo, riguroso y comunica con impacto a la comunidad. | El producto cumple con la mayoría de los requerimientos formales y comunica con claridad el mensaje. | El producto está incompleto o carece de elementos clave de presentación y contenido. |
...
> **Dramatización teatral comunitaria y lectura de atril ante padres de familia** enfocado en la resolución situada de: *Integración comunitaria de estudiantes migrantes, diálogo intercultural y cultura de paz en zonas de alta movilidad humana.*.
...
- Etiquetas: #lenguajes • #espanol • #3er_grado • #steam_con_enfoque_de_indagacion_cientifica_y_robotica
