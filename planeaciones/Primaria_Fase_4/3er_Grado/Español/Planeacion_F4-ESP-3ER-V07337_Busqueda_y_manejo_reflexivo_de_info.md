---
tags: [iskool, planeacion_nem, segundo_cerebro, fase4, campo_lenguajes, grado_3er_grado, materia_espanol, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_urbano_metropolitano]
id_planeacion: "F4-ESP-3ER-V07337"
...
fecha_creacion: "2026-08-24T20:07:46.604Z"
---

# 📚 Proyecto Didáctico Integral: Búsqueda y manejo reflexivo de información - Variante 7337 (Urbano Metropolitano)
...
1. **¿De qué manera el contenido de *"Búsqueda y manejo reflexivo de información"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Urbano Metropolitano)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Búsqueda y manejo reflexivo de información"*.
