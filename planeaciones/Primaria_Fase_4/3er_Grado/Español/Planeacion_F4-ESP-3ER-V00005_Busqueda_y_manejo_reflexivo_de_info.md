...
```yaml
PDA: "Elabora ensayos breves, reseñas críticas y participa en debates formales sobre "Búsqueda y manejo reflexivo de información", sustentando sus argumentos en fuentes confiables."
```

### 🔗 Articulación Curricular con otros Campos Formativos:
**1. Saberes y Pensamiento Científico:**
- *PDA:* Aplica modelos matemáticos (porcentajes, volumen, proporcionalidad) y el método experimental para investigar fenómenos asociados a "Búsqueda y manejo reflexivo de información".
...
- *PDA:* Evalúa críticamente los procesos socioambientales y las leyes que regulan problemáticas vinculadas a "Búsqueda y manejo reflexivo de información" a nivel nacional.
...
- *PDA:* Lidera proyectos comunitarios colaborativos orientados al bienestar común y la equidad social en torno a "Búsqueda y manejo reflexivo de información".
