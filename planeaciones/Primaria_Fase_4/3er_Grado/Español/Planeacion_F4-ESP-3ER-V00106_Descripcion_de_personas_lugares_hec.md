...
tema: "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)"
...
# 📚 Proyecto Didáctico Integral: Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)
...
```yaml
PDA: "Elabora ensayos breves, reseñas críticas y participa en debates formales sobre "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)", sustentando sus argumentos en fuentes confiables."
```
...
- *PDA:* Aplica modelos matemáticos (porcentajes, volumen, proporcionalidad) y el método experimental para investigar fenómenos asociados a "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)".
- *Vínculo formativo:* Pensamiento probabilístico, pensamiento STEM y experimentación científica rigurosa.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Evalúa críticamente los procesos históricos y problemáticas ambientales vinculadas a "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)" a nivel nacional y global.
- *Vínculo formativo:* Conciencia histórica de México, soberanía, sustentabilidad ecológica y derechos humanos.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Lidera proyectos comunitarios colaborativos orientados a la salud integral y la equidad social en torno a "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)".
...
Falta de medios impresos o digitales escolares donde las niñas y niños puedan comunicar hallazgos, opiniones fundamentadas y propuestas de mejora sobre "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)" para la comunidad.

**Propósito del Proyecto:**  
Desarrollar habilidades de investigación documental, redacción de textos informativos y argumentativos, y diseño editorial para socializar el tema de "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)".
- **🌟 Cierre (10 min):**  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola) con la vida comunitaria.
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)" de manera sencilla para que cualquiera los entienda?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Descripción de personas, lugares, hechos y procesos - Variante 106 (Rural Agrícola)" en tu vida diaria?
