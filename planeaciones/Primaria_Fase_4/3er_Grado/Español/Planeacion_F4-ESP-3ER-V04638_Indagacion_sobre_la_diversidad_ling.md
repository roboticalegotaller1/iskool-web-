---
tags: [iskool, planeacion_nem, segundo_cerebro, fase4, campo_lenguajes, grado_3er_grado, materia_espanol, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_zona_montanosa_y_boscosa]
id_planeacion: "F4-ESP-3ER-V04638"
...
fecha_creacion: "2026-08-24T20:07:42.306Z"
---

# 📚 Proyecto Didáctico Integral: Indagación sobre la diversidad lingüística en su comunidad y país - Variante 4638 (Zona Montañosa y Boscosa)
...
> **"Reconoce nombres de lugares y objetos con raíces en lenguas indígenas originarias, identificando variantes lingüísticas del español en México."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Indagación sobre la diversidad lingüística en su comunidad y país"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Zona Montañosa y Boscosa)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Indagación sobre la diversidad lingüística en su comunidad y país"*.
