---
tags: [iskool, planeacion_nem, segundo_cerebro, fase4, campo_lenguajes, grado_3er_grado, materia_espanol, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_comunitario_indigena_y_bilingue]
id_planeacion: "F4-ESP-3ER-V04427"
...
fecha_creacion: "2026-08-24T20:07:41.923Z"
---

# 📚 Proyecto Didáctico Integral: Comprensión y producción de resúmenes - Variante 4427 (Comunitario Indígena y Bilingüe)
...
> **"Reflexiona sobre las funciones del resumen conciso y objetivo, registrando ideas principales con sus propias palabras y empleando punto y aparte por párrafos."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Comprensión y producción de resúmenes"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Comunitario Indígena y Bilingüe)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Comprensión y producción de resúmenes"*.
