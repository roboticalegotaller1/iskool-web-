...
tema: "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información"
...
# 📚 Proyecto Didáctico Integral: � Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información
...
Falta de medios de difusión escolares donde los estudiantes puedan compartir investigaciones documentales, notas informativas y artículos de opinión verídicos sobre "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información".

**Propósito del Proyecto:**  
Desarrollar competencias de investigación periodística, redacción informativa y diseño editorial para socializar el tema "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información" mediante una gaceta escolar impresa y digital (Libro SEP: Proyectos Escolares).
...
1. ¿Cómo distinguimos una noticia fundamentada en hechos reales de un rumor o información falsa sobre "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información"?
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre � Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información"?  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula � Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información con la vida comunitaria.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "� Proyecto de Codiseño Comunitario: Búsqueda y manejo reflexivo de información" en tu vida diaria?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 6º Grado (Págs. 52 a la 54) — *Ensayos, reseñas críticas, crónicas y cartas de opinión*
