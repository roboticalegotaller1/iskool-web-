---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_3er_grado, materia_matematicas, metodologia_aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental, contexto_zona_costera_y_de_humedales, codiseno_2026]
id_planeacion: "SERIE2-F4-MAT-3ER-V19113"
...
fecha_creacion: "2026-08-24T21:50:07.260Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Estudio de los números naturales y fracciones en el contexto - Modalidad Innovadora 9113 (Zona Costera y de Humedales)
...
1. **¿Cómo podemos transformar el estudio de *"Estudio de los números naturales y fracciones en el contexto"* en una solución práctica para atender el reto de: *Protección de arrecifes, reforestación de manglares y gestión del agua potable ante el impacto del cambio climático.*?**
...
- **Sesión 2: Mapeo Conceptual y Rescate de Saberes Previos (50 min)**
  - *Inicio (10 min):* Dinámica de preguntas cruzadas entre equipos sobre conceptos clave de *"Estudio de los números naturales y fracciones en el contexto"*.
...
- **Sesión 4: Laboratorio Práctico / Experimentación y Prototipado (50 min)**
  ...
  - *Desarrollo (30 min):* Realización de experimentos, mediciones matemáticas, cálculos o modelado concreto enfocado en *"Estudio de los números naturales y fracciones en el contexto"*.
...
> **Recetario tradicional ilustrado con cálculo de aportes nutricionales y costo económico** aplicado a la atención situada de: *Protección de arrecifes, reforestación de manglares y gestión del agua potable ante el impacto del cambio climático.*.
