---
tags: [iskool, planeacion_nem, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_3er_grado, materia_matematicas, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_urbano_metropolitano]
id_planeacion: "F4-MAT-3ER-V09857"
...
fecha_creacion: "2026-08-24T20:07:50.488Z"
---

# 📚 Proyecto Didáctico Integral: Multiplicación y división como operaciones inversas - Variante 9857 (Urbano Metropolitano)
...
> **"Resuelve multiplicaciones cuyo producto sea de hasta tres cifras y divisiones mediante procedimientos de reparto y agrupamiento, expresando a ÷ b = c."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Multiplicación y división como operaciones inversas"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Urbano Metropolitano)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Multiplicación y división como operaciones inversas"*.
