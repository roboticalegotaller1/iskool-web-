...
tema: "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)"
...
# 📚 Proyecto Didáctico Integral: Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)
...
```yaml
PDA: "Elabora ensayos breves, reseñas críticas y participa en debates formales sobre "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)", sustentando sus argumentos en fuentes confiables."
```
...
- *PDA:* Aplica modelos matemáticos (porcentajes, volumen, proporcionalidad) y el método experimental para investigar fenómenos asociados a "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)".
- *Vínculo formativo:* Pensamiento probabilístico, pensamiento STEM y experimentación científica rigurosa.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Evalúa críticamente los procesos históricos y problemáticas ambientales vinculadas a "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)" a nivel nacional y global.
- *Vínculo formativo:* Conciencia histórica de México, soberanía, sustentabilidad ecológica y derechos humanos.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Lidera proyectos comunitarios colaborativos orientados a la salud integral y la equidad social en torno a "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)".
...
Los estudiantes requieren fortalecer el razonamiento lógico-matemático aplicado a situaciones de la vida real relacionadas con "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)" para resolver retos del entorno.
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)".
- **🌟 Cierre (10 min):**  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño) con la vida comunitaria.
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)" de manera sencilla para que cualquiera los entienda?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Suma y resta, su relación como operaciones inversas - Variante 236 (Costero y Ribereño)" en tu vida diaria?
