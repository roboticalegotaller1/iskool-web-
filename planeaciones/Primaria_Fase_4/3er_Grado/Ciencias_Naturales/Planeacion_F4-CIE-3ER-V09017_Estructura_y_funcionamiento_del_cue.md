---
tags: [iskool, planeacion_nem, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_3er_grado, materia_ciencias_naturales, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_urbano_metropolitano]
id_planeacion: "F4-CIE-3ER-V09017"
...
fecha_creacion: "2026-08-24T20:07:49.301Z"
---

# 📚 Proyecto Didáctico Integral: Estructura y funcionamiento del cuerpo humano: sistema locomotor y digestivo - Variante 9017 (Urbano Metropolitano)
...
1. **¿De qué manera el contenido de *"Estructura y funcionamiento del cuerpo humano: sistema locomotor y digestivo"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Urbano Metropolitano)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Estructura y funcionamiento del cuerpo humano: sistema locomotor y digestivo"*.
