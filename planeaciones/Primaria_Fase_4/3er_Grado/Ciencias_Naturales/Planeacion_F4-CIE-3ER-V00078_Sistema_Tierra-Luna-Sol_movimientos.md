...
tema: "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)"
...
# 📚 Proyecto Didáctico Integral: Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)
...
```yaml
PDA: "Comprende, sintetiza y redacta textos expositivos, informativos y esquemas visuales sobre "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)" para divulgar en el aula y la escuela."
```
...
- *PDA:* Resuelve situaciones problemáticas vinculadas a "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)" mediante operaciones básicas, fracciones, cálculo de áreas y experimentos sencillos.
- *Vínculo formativo:* Razonamiento lógico-matemático, análisis de datos en tablas y pensamiento indagatorio.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Analiza la diversidad natural y sociocultural de su entidad en torno a "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)", valorando la justicia y los derechos de todos.
- *Vínculo formativo:* Conocimiento del entorno regional, cuidado del medio ambiente y participación cívica.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Diseña estrategias cooperativas para prevenir riesgos y resolver conflictos escolares al trabajar proyectos sobre "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)".
...
Necesidad de fomentar la curiosidad científica, la indagación sistemática y la aplicación de saberes escolares para entender y transformar fenómenos relacionados con "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)"?  
  2. ¿Qué problema podríamos resolver en la escuela o en casa si dominamos este conocimiento?
- **📖 Libro de Texto SEP:** Nuestros Saberes 3º y 4º Grado (Págs. 101 a la 104) — *Ecosistemas, cadenas alimentarias y nutrición*
- **📦 Materiales:** Papel bond blanco, Plumones de colores, Material concreto o interactivo, Cuaderno del alumno
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)"?  
  2. ¿Cómo se relacionan estas definiciones con los ejemplos que analizamos en la sesión anterior?
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 3º Grado (Págs. 152 a la 155) — *Filtros de agua y composta escolar*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)".
- **🌟 Cierre (10 min):**  
...
- **📖 Libro de Texto SEP:** Nuestros Saberes 3º y 4º Grado (Págs. 107 a la 110) — *Ecosistemas, cadenas alimentarias y nutrición*
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)"?  
  2. ¿Cuál es el método más claro para explicar tu respuesta a los demás?
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 3º Grado (Págs. 158 a la 161) — *Filtros de agua y composta escolar*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)"?  
  2. ¿Cómo organizamos los datos para que cualquier persona de la comunidad los entienda con claridad?
- **📖 Libro de Texto SEP:** Nuestros Saberes 3º y 4º Grado (Págs. 113 a la 116) — *Ecosistemas, cadenas alimentarias y nutrición*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 3º Grado (Págs. 164 a la 167) — *Filtros de agua y composta escolar*
- **📦 Materiales:** Material artístico / cartulinas, Textos informativos complementarios, Plumones
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa) con la vida comunitaria.
...
- **📖 Libro de Texto SEP:** Nuestros Saberes 3º y 4º Grado (Págs. 119 a la 122) — *Ecosistemas, cadenas alimentarias y nutrición*
...
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 3º Grado (Págs. 170 a la 173) — *Filtros de agua y composta escolar*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)" de manera sencilla para que cualquiera los entienda?  
  2. ¿Qué tono de voz y postura corporal transmiten seguridad y entusiasmo en nuestra presentación?
- **📖 Libro de Texto SEP:** Nuestros Saberes 3º y 4º Grado (Págs. 125 a la 128) — *Ecosistemas, cadenas alimentarias y nutrición*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 78 (Zona Montañosa y Boscosa)" en tu vida diaria?
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 3º Grado (Págs. 176 a la 179) — *Filtros de agua y composta escolar*
