---
tags: [iskool, planeacion_nem, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_3er_grado, materia_ciencias_naturales, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_zona_montanosa_y_boscosa]
id_planeacion: "F4-CIE-3ER-V09438"
...
fecha_creacion: "2026-08-24T20:07:49.917Z"
---

# 📚 Proyecto Didáctico Integral: Sistema Tierra-Luna-Sol: movimientos de rotación y traslación - Variante 9438 (Zona Montañosa y Boscosa)
...
> **"Indaga y representa con modelos tridimensionales los movimientos de rotación y traslación de la Tierra y la Luna, asociándolos con el día, la noche, las fases lunares y las estaciones."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Sistema Tierra-Luna-Sol: movimientos de rotación y traslación"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Zona Montañosa y Boscosa)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Sistema Tierra-Luna-Sol: movimientos de rotación y traslación"*.
