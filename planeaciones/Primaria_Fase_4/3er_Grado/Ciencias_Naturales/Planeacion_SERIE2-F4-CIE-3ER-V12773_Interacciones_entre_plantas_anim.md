---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_3er_grado, materia_ciencias_naturales, metodologia_aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental, contexto_comunidad_escolar_multicultural_y_migrante, codiseno_2026]
id_planeacion: "SERIE2-F4-CIE-3ER-V12773"
...
tema: "Interacciones entre plantas, animales y el entorno natural"
...
fecha_creacion: "2026-08-24T21:49:57.651Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Interacciones entre plantas, animales y el entorno natural - Modalidad Innovadora 2773 (Comunidad Escolar Multicultural y Migrante)
...
> **"Clasifica animales en vertebrados e invertebrados con base en su locomoción, reconociendo que los seres humanos pertenecen al grupo de vertebrados."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Innovador

1. **¿Cómo podemos transformar el estudio de *"Interacciones entre plantas, animales y el entorno natural"* en una solución práctica para atender el reto de: *Integración inclusiva de familias en tránsito, cultura de paz y erradicación de toda forma de discriminación.*?**
...
- **Sesión 2: Mapeo Conceptual y Rescate de Saberes Previos (50 min)**
  - *Inicio (10 min):* Dinámica de preguntas cruzadas entre equipos sobre conceptos clave de *"Interacciones entre plantas, animales y el entorno natural"*.
...
- **Sesión 4: Laboratorio Práctico / Experimentación y Prototipado (50 min)**
  ...
  - *Desarrollo (30 min):* Realización de experimentos, mediciones matemáticas, cálculos o modelado concreto enfocado en *"Interacciones entre plantas, animales y el entorno natural"*.
