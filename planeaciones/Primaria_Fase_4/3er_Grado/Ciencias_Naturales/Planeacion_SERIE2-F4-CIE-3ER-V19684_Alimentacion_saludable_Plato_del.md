---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_3er_grado, materia_ciencias_naturales, metodologia_aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental, contexto_zona_lacustre_y_de_riberas, codiseno_2026]
id_planeacion: "SERIE2-F4-CIE-3ER-V19684"
...
tema: "Alimentación saludable: Plato del Bien Comer y prácticas culturales"
...
contexto_comunitario: "Zona Lacustre y de Riberas"
problematica_situada: "Saneamiento de cuerpos de agua, agricultura en chinampas y preservación de la biodiversidad acuática."
...
fecha_creacion: "2026-08-24T21:50:08.124Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Alimentación saludable: Plato del Bien Comer y prácticas culturales - Modalidad Innovadora 9684 (Zona Lacustre y de Riberas)
...
> - **Contexto Territorial:** Zona Lacustre y de Riberas (Reto Central: *Saneamiento de cuerpos de agua, agricultura en chinampas y preservación de la biodiversidad acuática.*)
...
> **"Explica la importancia de consumir verduras, frutas, cereales y leguminosas acorde al Plato del Bien Comer, bebiendo agua simple potable y reduciendo grasas y azúcares."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Innovador

1. **¿Cómo podemos transformar el estudio de *"Alimentación saludable: Plato del Bien Comer y prácticas culturales"* en una solución práctica para atender el reto de: *Saneamiento de cuerpos de agua, agricultura en chinampas y preservación de la biodiversidad acuática.*?**
...
- **Sesión 1: Apertura del Desafío y Planteamiento Situado (50 min)**
  - *Inicio (10 min):* Presentación del caso detonador en el entorno Zona Lacustre y de Riberas. El Prof. Israel López Ángeles contextualiza la problemática con imágenes y datos de campo.
  - *Desarrollo (30 min):* Debate abierto en asamblea escolar sobre *"Saneamiento de cuerpos de agua, agricultura en chinampas y preservación de la biodiversidad acuática."*. Conformación de equipos de trabajo con roles asignados (coordinación, bitácora, materiales, divulgación).
...
- **Sesión 2: Mapeo Conceptual y Rescate de Saberes Previos (50 min)**
  - *Inicio (10 min):* Dinámica de preguntas cruzadas entre equipos sobre conceptos clave de *"Alimentación saludable: Plato del Bien Comer y prácticas culturales"*.
...
- **Sesión 4: Laboratorio Práctico / Experimentación y Prototipado (50 min)**
  ...
  - *Desarrollo (30 min):* Realización de experimentos, mediciones matemáticas, cálculos o modelado concreto enfocado en *"Alimentación saludable: Plato del Bien Comer y prácticas culturales"*.
...
| :--- | :--- | :--- | :--- |
| **Apropiación del PDA Oficial** | Aplica con solvencia y rigor teórico el contenido *"Alimentación saludable: Plato del Bien Comer y prácticas culturales"*, integrando conceptos clave y explicaciones fundamentadas. | Comprende y explica los elementos esenciales del PDA con adecuado nivel de detalle. | Identifica nociones generales del contenido pero requiere apoyo para su explicación sistemática. |
| **Pertinencia Situada (Zona Lacustre y de Riberas)** | Diseña respuestas innovadoras que atienden directamente el desafío *"Saneamiento de cuerpos de agua, agricultura en chinampas y preservación de la biodiversidad acuática."*, demostrando conciencia social y ecológica. | Vincula de manera correcta el proyecto con las condiciones de su comunidad o escuela. | Hace mención al contexto de forma aislada sin articularlo a la propuesta técnica. |
...
> **Obra de teatro guiñol y libreto dramático original sobre resolución pacífica de conflictos** aplicado a la atención situada de: *Saneamiento de cuerpos de agua, agricultura en chinampas y preservación de la biodiversidad acuática.*.
