---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_3er_grado, materia_ciencias_naturales, metodologia_aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental, contexto_region_forestal_y_de_alta_montana, codiseno_2026]
id_planeacion: "SERIE2-F4-CIE-3ER-V17283"
...
tema: "Estructura y funcionamiento del cuerpo humano: sistema locomotor y digestivo"
...
contexto_comunitario: "Región Forestal y de Alta Montaña"
problematica_situada: "Monitoreo de fauna endémica, prevención comunitaria de incendios y conservación de bosques de niebla."
...
fecha_creacion: "2026-08-24T21:50:04.585Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Estructura y funcionamiento del cuerpo humano: sistema locomotor y digestivo - Modalidad Innovadora 7283 (Región Forestal y de Alta Montaña)
...
> - **Contexto Territorial:** Región Forestal y de Alta Montaña (Reto Central: *Monitoreo de fauna endémica, prevención comunitaria de incendios y conservación de bosques de niebla.*)
...
> **"Identifica que el sistema locomotor está conformado por el sistema óseo y muscular; explica la coordinación neuromuscular y describe prácticas para su cuidado y prevención de lesiones."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Innovador

1. **¿Cómo podemos transformar el estudio de *"Estructura y funcionamiento del cuerpo humano: sistema locomotor y digestivo"* en una solución práctica para atender el reto de: *Monitoreo de fauna endémica, prevención comunitaria de incendios y conservación de bosques de niebla.*?**
...
- **Sesión 1: Apertura del Desafío y Planteamiento Situado (50 min)**
  - *Inicio (10 min):* Presentación del caso detonador en el entorno Región Forestal y de Alta Montaña. El Prof. Israel López Ángeles contextualiza la problemática con imágenes y datos de campo.
  - *Desarrollo (30 min):* Debate abierto en asamblea escolar sobre *"Monitoreo de fauna endémica, prevención comunitaria de incendios y conservación de bosques de niebla."*. Conformación de equipos de trabajo con roles asignados (coordinación, bitácora, materiales, divulgación).
...
- **Sesión 2: Mapeo Conceptual y Rescate de Saberes Previos (50 min)**
  - *Inicio (10 min):* Dinámica de preguntas cruzadas entre equipos sobre conceptos clave de *"Estructura y funcionamiento del cuerpo humano: sistema locomotor y digestivo"*.
...
- **Sesión 4: Laboratorio Práctico / Experimentación y Prototipado (50 min)**
  ...
  - *Desarrollo (30 min):* Realización de experimentos, mediciones matemáticas, cálculos o modelado concreto enfocado en *"Estructura y funcionamiento del cuerpo humano: sistema locomotor y digestivo"*.
...
| :--- | :--- | :--- | :--- |
| **Apropiación del PDA Oficial** | Aplica con solvencia y rigor teórico el contenido *"Estructura y funcionamiento del cuerpo humano: sistema locomotor y digestivo"*, integrando conceptos clave y explicaciones fundamentadas. | Comprende y explica los elementos esenciales del PDA con adecuado nivel de detalle. | Identifica nociones generales del contenido pero requiere apoyo para su explicación sistemática. |
| **Pertinencia Situada (Región Forestal y de Alta Montaña)** | Diseña respuestas innovadoras que atienden directamente el desafío *"Monitoreo de fauna endémica, prevención comunitaria de incendios y conservación de bosques de niebla."*, demostrando conciencia social y ecológica. | Vincula de manera correcta el proyecto con las condiciones de su comunidad o escuela. | Hace mención al contexto de forma aislada sin articularlo a la propuesta técnica. |
...
> **Recetario tradicional ilustrado con cálculo de aportes nutricionales y costo económico** aplicado a la atención situada de: *Monitoreo de fauna endémica, prevención comunitaria de incendios y conservación de bosques de niebla.*.
...
- Etiquetas: #saberes_y_pensamiento_cientifico • #ciencias_naturales • #3er_grado • #aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental • #codiseno_2026
