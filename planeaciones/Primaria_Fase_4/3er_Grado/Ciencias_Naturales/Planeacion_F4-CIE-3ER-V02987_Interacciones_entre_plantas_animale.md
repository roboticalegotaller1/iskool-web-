---
tags: [iskool, planeacion_nem, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_3er_grado, materia_ciencias_naturales, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_comunitario_indigena_y_bilingue]
id_planeacion: "F4-CIE-3ER-V02987"
campo_formativo: "Saberes y Pensamiento Científico"
materia: "Ciencias_Naturales"
grado: "3º de Primaria"
nivel: "Primaria Fase 4"
tema: "Interacciones entre plantas, animales y el entorno natural: locomoción y nutrición"
...
fecha_creacion: "2026-08-24T20:07:39.392Z"
---

# 📚 Proyecto Didáctico Integral: Interacciones entre plantas, animales y el entorno natural: locomoción y nutrición - Variante 2987 (Comunitario Indígena y Bilingüe)
...
1. **¿De qué manera el contenido de *"Interacciones entre plantas, animales y el entorno natural: locomoción y nutrición"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Comunitario Indígena y Bilingüe)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Interacciones entre plantas, animales y el entorno natural: locomoción y nutrición"*.
...
- Etiquetas: #saberes_y_pensamiento_cientifico • #ciencias_naturales • #3er_grado • #steam_con_enfoque_de_indagacion_cientifica_y_robotica
