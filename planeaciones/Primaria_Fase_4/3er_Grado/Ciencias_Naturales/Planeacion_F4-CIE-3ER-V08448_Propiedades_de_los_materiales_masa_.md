---
tags: [iskool, planeacion_nem, segundo_cerebro, fase4, campo_saberes_y_pensamiento_cientifico, grado_3er_grado, materia_ciencias_naturales, metodologia_aprendizaje_basado_en_problemas_abp_, contexto_fronterizo_e_intercultural]
id_planeacion: "F4-CIE-3ER-V08448"
...
fecha_creacion: "2026-08-24T20:07:48.446Z"
---

# 📚 Proyecto Didáctico Integral: Propiedades de los materiales: masa y longitud; relación con temperatura - Variante 8448 (Fronterizo e Intercultural)
...
> **"Describe la masa (kg) y la longitud (m, cm) como propiedades medibles de los materiales usando balanza y regla, relacionando tamaño, forma y estado físico."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Propiedades de los materiales: masa y longitud; relación con temperatura"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Fronterizo e Intercultural)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Propiedades de los materiales: masa y longitud; relación con temperatura"*.
...
- Etiquetas: #saberes_y_pensamiento_cientifico • #ciencias_naturales • #3er_grado • #aprendizaje_basado_en_problemas_abp_
