...
tema: "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario"
...
# 📚 Proyecto Didáctico Integral: Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario
...
```yaml
PDA: "Elabora ensayos breves, reseñas críticas y participa en debates formales sobre "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario", sustentando sus argumentos en fuentes confiables."
```
...
- *PDA:* Aplica modelos matemáticos (porcentajes, volumen, proporcionalidad) y el método experimental para investigar fenómenos asociados a "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario".
- *Vínculo formativo:* Pensamiento probabilístico, pensamiento STEM y experimentación científica rigurosa.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Evalúa críticamente los procesos históricos y problemáticas ambientales vinculadas a "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario" a nivel nacional y global.
- *Vínculo formativo:* Conciencia histórica de México, soberanía, sustentabilidad ecológica y derechos humanos.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Lidera proyectos comunitarios colaborativos orientados a la salud integral y la equidad social en torno a "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario".
...
Falta de medios impresos o digitales escolares donde las niñas y niños puedan comunicar hallazgos, opiniones fundamentadas y propuestas de mejora sobre "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario" para la comunidad.

**Propósito del Proyecto:**  
Desarrollar habilidades de investigación documental, redacción de textos informativos y argumentativos, y diseño editorial para socializar el tema de "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario".
- **🌟 Cierre (10 min):**  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario con la vida comunitaria.
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario" de manera sencilla para que cualquiera los entienda?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Raíces Vivas: Toponimias Indígenas y Palabras de Origen Originario" en tu vida diaria?
