...
tema: "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego"
...
# 📚 Proyecto Didáctico Integral: � Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego
...
Elevada incidencia de consumo de alimentos ultraprocesados, hábitos sedentarios y falta de información accesible sobre el cuidado integral del cuerpo humano en torno a "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre � Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego"?  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula � Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego con la vida comunitaria.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego" en tu vida diaria?
...
| :--- | :--- | :--- | :--- |
| **Comprensión Nutricional y Fisiológica del Cuerpo** | Explica con precisión la función de los nutrientes, los riesgos del consumo excesivo de azúcares y grasas, y la fisiología del cuerpo humano frente a "� Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego". | Identifica los grupos del Plato del Bien Comer y propone opciones de menús balanceados. | Confunde los grupos nutrimentales o desconoce la función básica de los órganos. |
