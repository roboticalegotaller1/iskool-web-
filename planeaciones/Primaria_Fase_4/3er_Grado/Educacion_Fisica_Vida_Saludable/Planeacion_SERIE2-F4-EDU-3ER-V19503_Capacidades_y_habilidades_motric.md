---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase4, campo_de_lo_humano_y_lo_comunitario, grado_3er_grado, materia_educacion_fisica_vida_saludable, metodologia_aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental, contexto_comunidad_rural_agroecologica, codiseno_2026]
id_planeacion: "SERIE2-F4-EDU-3ER-V19503"
...
fecha_creacion: "2026-08-24T21:50:07.804Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Capacidades y habilidades motrices en situaciones de juego - Modalidad Innovadora 9503 (Comunidad Rural Agroecológica)
...
> **"Adapta sus patrones básicos de movimiento en juegos cooperativos y deportivos para favorecer la coordinación motriz, la sana convivencia y el autoconcepto positivo."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Innovador

1. **¿Cómo podemos transformar el estudio de *"Capacidades y habilidades motrices en situaciones de juego"* en una solución práctica para atender el reto de: *Transición hacia biofertilizantes, conservación de maíces nativos y rescate de técnicas milperas sustentables.*?**
...
- **Sesión 2: Mapeo Conceptual y Rescate de Saberes Previos (50 min)**
  - *Inicio (10 min):* Dinámica de preguntas cruzadas entre equipos sobre conceptos clave de *"Capacidades y habilidades motrices en situaciones de juego"*.
...
- **Sesión 4: Laboratorio Práctico / Experimentación y Prototipado (50 min)**
  ...
  - *Desarrollo (30 min):* Realización de experimentos, mediciones matemáticas, cálculos o modelado concreto enfocado en *"Capacidades y habilidades motrices en situaciones de juego"*.
...
- **Sesión 6: Bocetaje y Diseño del Producto Tangible (50 min)**
  ...
  - *Desarrollo (30 min):* Taller creativo: modelado, estructuración o redacción del primer prototipo de: *Recetario tradicional ilustrado con cálculo de aportes nutricionales y costo económico*.
...
> **Recetario tradicional ilustrado con cálculo de aportes nutricionales y costo económico** aplicado a la atención situada de: *Transición hacia biofertilizantes, conservación de maíces nativos y rescate de técnicas milperas sustentables.*.
...
- Etiquetas: #de_lo_humano_y_lo_comunitario • #educacion_fisica_vida_saludable • #3er_grado • #aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental • #codiseno_2026
