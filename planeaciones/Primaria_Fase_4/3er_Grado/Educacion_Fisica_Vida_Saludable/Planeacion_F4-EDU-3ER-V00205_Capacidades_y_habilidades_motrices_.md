...
```yaml
PDA: "Lidera proyectos comunitarios colaborativos orientados al bienestar común y la equidad social en torno a "Capacidades y habilidades motrices en situaciones de juego"."
```

### 🔗 Articulación Curricular con otros Campos Formativos:
**1. Lenguajes (Primaria Alta - Fase 5):**
- *PDA:* Elabora ensayos breves, reseñas críticas y participa en debates formales sobre "Capacidades y habilidades motrices en situaciones de juego", sustentando sus argumentos en fuentes confiables.
- *Vínculo formativo:* Pensamiento crítico discursivo, análisis literario e informativo y comunicación oral asertiva.

**2. Saberes y Pensamiento Científico:**
- *PDA:* Aplica modelos matemáticos (porcentajes, volumen, proporcionalidad) y el método experimental para investigar fenómenos asociados a "Capacidades y habilidades motrices en situaciones de juego".
- *Vínculo formativo:* Pensamiento probabilístico, pensamiento STEM y experimentación científica rigurosa.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Evalúa críticamente los procesos socioambientales y las leyes que regulan problemáticas vinculadas a "Capacidades y habilidades motrices en situaciones de juego" a nivel nacional.
