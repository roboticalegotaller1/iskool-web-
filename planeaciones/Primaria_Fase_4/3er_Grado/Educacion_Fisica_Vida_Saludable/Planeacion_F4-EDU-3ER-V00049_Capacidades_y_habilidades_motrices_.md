...
tema: "Capacidades y habilidades motrices en situaciones de juego"
...
# 📚 Proyecto Didáctico Integral: Capacidades y habilidades motrices en situaciones de juego
...
```yaml
PDA: "Colabora en equipos escolares mediante acuerdos consensuados, diálogo empático y distribución equitativa de roles para desarrollar propuestas de acción comunitaria sobre "Capacidades y habilidades motrices en situaciones de juego"."
```

### 🔗 Articulación Curricular con otros Campos Formativos:
**1. Lenguajes (Primaria Media - Fase 4):**
- *PDA:* Indaga en diversas fuentes informativas, sintetiza ideas clave y redacta textos explicativos e instructivos estructurados sobre "Capacidades y habilidades motrices en situaciones de juego" empleando conectores lógicos y signos de puntuación.
- *Vínculo formativo:* Comprensión lectora analítica, redacción estructurada en párrafos y divulgación de saberes.

**2. Saberes y Pensamiento Científico:**
- *PDA:* Plantea preguntas, formula hipótesis tentativas y registra observaciones empíricas sistemáticas sobre los componentes y fenómenos de "Capacidades y habilidades motrices en situaciones de juego" en su entorno escolar y comunitario.
- *Vínculo formativo:* Indagación científica escolar, pensamiento lógico y registro riguroso de evidencias empíricas.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Examina la relevancia y consecuencias sociales o ambientales de "Capacidades y habilidades motrices en situaciones de juego" en la vida cotidiana de su entidad federativa, proponiendo acciones orientadas al bien común.
...
Elevada incidencia de consumo de alimentos ultraprocesados, hábitos sedentarios y falta de información accesible sobre el cuidado integral del cuerpo humano en torno a "Capacidades y habilidades motrices en situaciones de juego".
...
1. ¿Cómo se relacionan los grupos del Plato del Bien Comer y la Jarra del Buen Beber con el funcionamiento del sistema digestivo y circulatorio?
2. ¿Qué riesgos reales para la salud provocan el consumo frecuente de bebidas azucaradas y alimentos ultraprocesados en nuestra comunidad escolar?
3. ¿Qué propuesta de colaciones saludables y accesibles podemos promover en la cooperativa escolar para mejorar la nutrición de todos?

---

## 📅 IV. Secuencia Didáctica Completa (Dosificación en 10 Bloques de 50 Minutos)

### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Capacidades y habilidades motrices en situaciones de juego"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "Capacidades y habilidades motrices en situaciones de juego". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Capacidades y habilidades motrices en situaciones de juego" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Capacidades y habilidades motrices en situaciones de juego?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "Capacidades y habilidades motrices en situaciones de juego"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Capacidades y habilidades motrices en situaciones de juego".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "Capacidades y habilidades motrices en situaciones de juego"?  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Capacidades y habilidades motrices en situaciones de juego".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "Capacidades y habilidades motrices en situaciones de juego"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Capacidades y habilidades motrices en situaciones de juego"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Capacidades y habilidades motrices en situaciones de juego" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Capacidades y habilidades motrices en situaciones de juego con la vida comunitaria.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Capacidades y habilidades motrices en situaciones de juego".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "Capacidades y habilidades motrices en situaciones de juego" en tu vida diaria?
...
| :--- | :--- | :--- | :--- |
| **Comprensión Nutricional y Fisiológica del Cuerpo** | Explica con precisión la función de los nutrientes, los riesgos del consumo excesivo de azúcares y grasas, y la fisiología del cuerpo humano frente a "Capacidades y habilidades motrices en situaciones de juego". | Identifica los grupos del Plato del Bien Comer y propone opciones de menús balanceados. | Confunde los grupos nutrimentales o desconoce la función básica de los órganos. |
