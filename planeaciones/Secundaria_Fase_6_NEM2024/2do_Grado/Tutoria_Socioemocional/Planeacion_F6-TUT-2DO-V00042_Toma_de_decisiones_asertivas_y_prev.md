---
tags: [iskool, planeacion_nem, segundo_cerebro, boveda_curricular, nivel_secundaria, materia_tutoria_socioemocional, grado_2_de_secundaria]
...
tema: "Toma de decisiones asertivas y prevención de adicciones"
...
# 📚 Proyecto Didáctico Integral: Toma de decisiones asertivas y prevención de adicciones
...
```yaml
PDA: "Diseña prototipos tecnológicos y propuestas productivas comunitarias orientadas a la innovación y el proyecto de vida en torno a "Toma de decisiones asertivas y prevención de adicciones"."
```

### 🔗 Articulación Curricular con otros Campos Formativos:
**1. Saberes y Pensamiento Científico (Secundaria - Fase 6):**
- *PDA:* Modela situaciones y fenómenos reales relacionados con "Toma de decisiones asertivas y prevención de adicciones" mediante expresiones algebraicas, gráficas, funciones y contrastación experimental de laboratorio.
...
- *PDA:* Produce ensayos académicos, artículos de divulgación y participa en mesas redondas formales sobre "Toma de decisiones asertivas y prevención de adicciones" con rigor metodológico y citas textuales.
- *Vínculo formativo:* Argumentación crítica avanzada, dialéctica y divulgación del conocimiento científico.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Analiza críticamente las causas estructurales, históricas y éticas de las problemáticas socioambientales ligadas a "Toma de decisiones asertivas y prevención de adicciones".
...
Necesidad de fortalecer el autoconocimiento socioemocional, la empatía y el desarrollo motriz a través de actividades lúdicas cooperativas vinculadas a "Toma de decisiones asertivas y prevención de adicciones".
...
1. ¿Cuáles son las implicaciones éticas, sociales y científicas de "Toma de decisiones asertivas y prevención de adicciones" en el contexto actual de nuestro país?
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Problema Sociocrítico y Delimitación Científica de "Toma de decisiones asertivas y prevención de adicciones"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Presentación de un caso de estudio real o discrepancia conceptual sobre "Toma de decisiones asertivas y prevención de adicciones". Debate inicial en plenaria guiado con preguntas de conflicto cognitivo.
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cuáles son los factores estructurales que originan las problemáticas en torno a "Toma de decisiones asertivas y prevención de adicciones"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Ejecución de la práctica experimental, desarrollo de modelos algebraicos/geométricos o ensamblaje de prototipos funcionales vinculados a "Toma de decisiones asertivas y prevención de adicciones". Registro sistemático de variables.
- **🌟 Cierre (10 min):**  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Realización del debate argumentativo. Los equipos defienden posturas fundamentadas con evidencias científicas, históricas o éticas sobre "Toma de decisiones asertivas y prevención de adicciones".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cuál es la responsabilidad social de la ciencia y la tecnología en torno a "Toma de decisiones asertivas y prevención de adicciones"?
...
| :--- | :--- | :--- | :--- |
| **Reconocimiento y Gestión Emocional** | Identifica y nombra sus emociones con asertividad, aplicando estrategias de autorregulación y empatía hacia sus pares sobre "Toma de decisiones asertivas y prevención de adicciones". | Expresa sus sentimientos con respeto y reconoce cómo se sienten sus compañeros. | Presenta dificultades para regular el enojo o la frustración durante los juegos. |
