---
tags: [iskool, planeacion_nem, segundo_cerebro, fase6, campo_de_lo_humano_y_lo_comunitario, grado_1er_grado, materia_educacion_fisica, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_rural_agricola]
id_planeacion: "F6-EDU-1ER-V07818"
...
fecha_creacion: "2026-08-24T20:08:19.709Z"
---

# 📚 Proyecto Didáctico Integral: Condición física, capacidades motrices y estilos de vida activos - Variante 7818 (Rural Agrícola)
...
> **"Pone a prueba su potencial motriz en actividades recreativas y predeportivas, valorando el ejercicio físico diario para la salud integral."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Condición física, capacidades motrices y estilos de vida activos"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Rural Agrícola)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Condición física, capacidades motrices y estilos de vida activos"*.
...
- Etiquetas: #de_lo_humano_y_lo_comunitario • #educacion_fisica • #1er_grado • #steam_con_enfoque_de_indagacion_cientifica_y_robotica
