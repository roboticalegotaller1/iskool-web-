---
tags: [iskool, planeacion_nem, segundo_cerebro, boveda_curricular, nivel_secundaria, materia_espanol, grado_3_de_secundaria]
...
tema: "Comunicación asertiva y dialógica para erradicar la violencia"
...
# 📚 Proyecto Didáctico Integral: Comunicación asertiva y dialógica para erradicar la violencia
...
```yaml
PDA: "Produce ensayos académicos, artículos de divulgación y participa en mesas redondas formales sobre "Comunicación asertiva y dialógica para erradicar la violencia" con rigor metodológico y citas textuales."
```

### 🔗 Articulación Curricular con otros Campos Formativos:
**1. Saberes y Pensamiento Científico (Secundaria - Fase 6):**
- *PDA:* Modela situaciones y fenómenos reales relacionados con "Comunicación asertiva y dialógica para erradicar la violencia" mediante expresiones algebraicas, gráficas, funciones y contrastación experimental de laboratorio.
...
- *PDA:* Analiza críticamente las causas estructurales, históricas y éticas de las problemáticas socioambientales ligadas a "Comunicación asertiva y dialógica para erradicar la violencia".
...
- *PDA:* Diseña prototipos tecnológicos y propuestas productivas comunitarias orientadas a la innovación y el proyecto de vida en torno a "Comunicación asertiva y dialógica para erradicar la violencia".
...
Falta de medios de difusión escolares donde los estudiantes puedan compartir investigaciones documentales, notas informativas y artículos de opinión verídicos sobre "Comunicación asertiva y dialógica para erradicar la violencia".

**Propósito del Proyecto:**  
Desarrollar competencias de investigación periodística, redacción informativa y diseño editorial para socializar el tema "Comunicación asertiva y dialógica para erradicar la violencia" mediante una gaceta escolar impresa y digital (Libro SEP: Proyectos Escolares).
...
2. ¿Cómo se estructura un texto argumentativo formal para defender una postura crítica con evidencias sólidas sobre "Comunicación asertiva y dialógica para erradicar la violencia"?
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Problema Sociocrítico y Delimitación Científica de "Comunicación asertiva y dialógica para erradicar la violencia"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Presentación de un caso de estudio real o discrepancia conceptual sobre "Comunicación asertiva y dialógica para erradicar la violencia". Debate inicial en plenaria guiado con preguntas de conflicto cognitivo.
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cuáles son los factores estructurales que originan las problemáticas en torno a "Comunicación asertiva y dialógica para erradicar la violencia"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Ejecución de la práctica experimental, desarrollo de modelos algebraicos/geométricos o ensamblaje de prototipos funcionales vinculados a "Comunicación asertiva y dialógica para erradicar la violencia". Registro sistemático de variables.
- **🌟 Cierre (10 min):**  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Realización del debate argumentativo. Los equipos defienden posturas fundamentadas con evidencias científicas, históricas o éticas sobre "Comunicación asertiva y dialógica para erradicar la violencia".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cuál es la responsabilidad social de la ciencia y la tecnología en torno a "Comunicación asertiva y dialógica para erradicar la violencia"?
