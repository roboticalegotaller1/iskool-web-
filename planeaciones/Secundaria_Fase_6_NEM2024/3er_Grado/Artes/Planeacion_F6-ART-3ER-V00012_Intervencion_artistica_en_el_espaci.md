---
tags: [iskool, planeacion_nem, segundo_cerebro, boveda_curricular, nivel_secundaria, materia_artes, grado_3_de_secundaria]
...
tema: "Intervención artística en el espacio público y memoria colectiva"
...
# 📚 Proyecto Didáctico Integral: Intervención artística en el espacio público y memoria colectiva
...
```yaml
PDA: "Produce ensayos académicos, artículos de divulgación y participa en mesas redondas formales sobre "Intervención artística en el espacio público y memoria colectiva" con rigor metodológico y citas textuales."
```

### 🔗 Articulación Curricular con otros Campos Formativos:
**1. Saberes y Pensamiento Científico (Secundaria - Fase 6):**
- *PDA:* Modela situaciones y fenómenos reales relacionados con "Intervención artística en el espacio público y memoria colectiva" mediante expresiones algebraicas, gráficas, funciones y contrastación experimental de laboratorio.
...
- *PDA:* Analiza críticamente las causas estructurales, históricas y éticas de las problemáticas socioambientales ligadas a "Intervención artística en el espacio público y memoria colectiva".
...
- *PDA:* Diseña prototipos tecnológicos y propuestas productivas comunitarias orientadas a la innovación y el proyecto de vida en torno a "Intervención artística en el espacio público y memoria colectiva".
...
Limitados espacios para la exploración de técnicas artísticas multidisciplinarias (pintura, grabado, escultura, arte efímero) y la valoración estética del entorno escolar vinculada a "Intervención artística en el espacio público y memoria colectiva".
...
1. ¿Cómo desafían las corrientes artísticas contemporáneas los cánones tradicionales de belleza y representación en torno a "Intervención artística en el espacio público y memoria colectiva"?
2. ¿Qué función social desempeña el arte efímero y el performance en la sensibilización comunitaria sobre las problemáticas actuales?
3. ¿De qué forma la curaduría artística propicia una experiencia dialógica transformadora en los espectadores?

---

## 📅 IV. Secuencia Didáctica Completa (Dosificación en 10 Bloques de 50 Minutos)

### 📌 SESIÓN 1 (50 minutos): Planteamiento del Problema Sociocrítico y Delimitación Científica de "Intervención artística en el espacio público y memoria colectiva"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Presentación de un caso de estudio real o discrepancia conceptual sobre "Intervención artística en el espacio público y memoria colectiva". Debate inicial en plenaria guiado con preguntas de conflicto cognitivo.
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cuáles son los factores estructurales que originan las problemáticas en torno a "Intervención artística en el espacio público y memoria colectiva"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Ejecución de la práctica experimental, desarrollo de modelos algebraicos/geométricos o ensamblaje de prototipos funcionales vinculados a "Intervención artística en el espacio público y memoria colectiva". Registro sistemático de variables.
- **🌟 Cierre (10 min):**  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Realización del debate argumentativo. Los equipos defienden posturas fundamentadas con evidencias científicas, históricas o éticas sobre "Intervención artística en el espacio público y memoria colectiva".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cuál es la responsabilidad social de la ciencia y la tecnología en torno a "Intervención artística en el espacio público y memoria colectiva"?
