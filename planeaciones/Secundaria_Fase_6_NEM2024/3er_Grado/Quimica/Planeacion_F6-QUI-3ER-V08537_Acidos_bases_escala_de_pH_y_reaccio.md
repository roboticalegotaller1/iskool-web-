---
tags: [iskool, planeacion_nem, segundo_cerebro, fase6, campo_saberes_y_pensamiento_cientifico, grado_3er_grado, materia_quimica, metodologia_steam_con_enfoque_de_indagacion_cientifica_y_robotica, contexto_urbano_metropolitano]
id_planeacion: "F6-QUI-3ER-V08537"
campo_formativo: "Saberes y Pensamiento Científico"
materia: "Quimica"
grado: "3º de Secundaria"
nivel: "Secundaria Fase 6 NEM2024"
tema: "Ácidos, bases, escala de pH y reacciones de neutralización"
...
fecha_creacion: "2026-08-24T20:08:20.902Z"
---

# 📚 Proyecto Didáctico Integral: Ácidos, bases, escala de pH y reacciones de neutralización - Variante 8537 (Urbano Metropolitano)
...
> **"Distingue propiedades ácidas y básicas con indicadores naturales, deduciendo productos de reacciones de neutralización y remediación ambiental."**

---

## ❓ II. Preguntas Detonadoras y Conflicto Cognitivo Situado

1. **¿De qué manera el contenido de *"Ácidos, bases, escala de pH y reacciones de neutralización"* impacta directamente en nuestra vida diaria y en los retos de nuestro entorno (Urbano Metropolitano)?**
...
- **Sesión 2: Diagnóstico y Registro de Saberes Previos (50 min)**
  ...
  - *Desarrollo (30 min):* Elaboración de un mapa conceptual grupal con los conceptos clave de *"Ácidos, bases, escala de pH y reacciones de neutralización"*.
