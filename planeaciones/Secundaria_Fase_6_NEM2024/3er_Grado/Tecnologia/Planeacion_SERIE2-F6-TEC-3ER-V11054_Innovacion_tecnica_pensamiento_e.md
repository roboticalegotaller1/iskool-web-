---
tags: [iskool, planeacion_nem_serie2, segundo_cerebro, fase6, campo_de_lo_humano_y_lo_comunitario, grado_3er_grado, materia_tecnologia, metodologia_aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental, contexto_ecosistema_urbano_sostenible, codiseno_2026]
id_planeacion: "SERIE2-F6-TEC-3ER-V11054"
...
fecha_creacion: "2026-08-24T21:50:24.744Z"
---

# 🚀 Proyecto de Codiseño Comunitario: Innovación técnica, pensamiento estratégico y evaluación de proyectos - Modalidad Innovadora 1054 (Ecosistema Urbano Sostenible)
...
1. **¿Cómo podemos transformar el estudio de *"Innovación técnica, pensamiento estratégico y evaluación de proyectos"* en una solución práctica para atender el reto de: *Implementación de huertos verticales, captación pluvial urbana y mitigación de islas de calor en escuelas metropolitanas.*?**
...
- **Sesión 2: Mapeo Conceptual y Rescate de Saberes Previos (50 min)**
  - *Inicio (10 min):* Dinámica de preguntas cruzadas entre equipos sobre conceptos clave de *"Innovación técnica, pensamiento estratégico y evaluación de proyectos"*.
...
- **Sesión 4: Laboratorio Práctico / Experimentación y Prototipado (50 min)**
  ...
  - *Desarrollo (30 min):* Realización de experimentos, mediciones matemáticas, cálculos o modelado concreto enfocado en *"Innovación técnica, pensamiento estratégico y evaluación de proyectos"*.
...
> **Obra de teatro guiñol y libreto dramático original sobre resolución pacífica de conflictos** aplicado a la atención situada de: *Implementación de huertos verticales, captación pluvial urbana y mitigación de islas de calor en escuelas metropolitanas.*.
...
- Etiquetas: #de_lo_humano_y_lo_comunitario • #tecnologia • #3er_grado • #aprendizaje_basado_en_proyectos_comunitarios_con_enfoque_socioambiental • #codiseno_2026
