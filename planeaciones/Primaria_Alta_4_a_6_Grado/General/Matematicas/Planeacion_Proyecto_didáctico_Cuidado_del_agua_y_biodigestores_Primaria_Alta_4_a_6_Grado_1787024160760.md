---
tags: [iskool, planeacion_nem, segundo_cerebro, boveda_curricular, nivel_primaria_alta, materia_matematicas, grado_no_especificado]
...
tema: "Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)"
...
# 📚 Proyecto Didáctico Integral: Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)

> **Docente Titular:** [[Prof_Israel_Lopez_Angeles|Prof. Israel López Ángeles]]  
> **Nivel y Fase:** PRIMARIA-ALTA • Fase 5 (No especificado)  
...
```yaml
PDA: "Elabora ensayos breves, reseñas críticas y participa en debates formales sobre "Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)", sustentando sus argumentos en fuentes confiables."
```
...
- *PDA:* Aplica modelos matemáticos (porcentajes, volumen, proporcionalidad) y el método experimental para investigar fenómenos asociados a "Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)".
- *Vínculo formativo:* Pensamiento probabilístico, pensamiento STEM y experimentación científica rigurosa.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Evalúa críticamente los procesos históricos y problemáticas ambientales vinculadas a "Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)" a nivel nacional y global.
- *Vínculo formativo:* Conciencia histórica de México, soberanía, sustentabilidad ecológica y derechos humanos.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Lidera proyectos comunitarios colaborativos orientados a la salud integral y la equidad social en torno a "Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)?".
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)".
- **🌟 Cierre (10 min):**  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)".
- **🔬 Desarrollo (30 min):**  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Cuidado del agua y biodigestores — Primaria Alta (4º a 6º Grado)".
- **🌟 Cierre (10 min):**  
