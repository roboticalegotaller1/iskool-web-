...
```yaml
PDA: "Registra y resume información sobre "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)" a través de la escritura autónoma, el dibujo y el dictado al docente para compartir con la comunidad."
```
...
- *PDA:* Utiliza material concreto, dibujos y símbolos para representar cantidades, medidas y patrones vinculados a "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)".
- *Vínculo formativo:* Fundamentación lógica, conteo, medición y resolución de problemas prácticos cotidianos.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Reconoce el impacto de las acciones individuales y colectivas en relación con "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)" en su entorno escolar y familiar.
- *Vínculo formativo:* Compromiso ciudadano, cuidado del entorno y convivencia pacífica.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Participa en juegos y actividades colaborativas relacionadas con "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)", respetando acuerdos y turnos de participación.
...
Falta de medios impresos o digitales escolares donde las niñas y niños puedan comunicar hallazgos, opiniones fundamentadas y propuestas de mejora sobre "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)" para la comunidad.

**Propósito del Proyecto:**  
Desarrollar habilidades de investigación documental, redacción de textos informativos y argumentativos, y diseño editorial para socializar el tema de "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)"?  
  2. ¿Qué problema podríamos resolver en la escuela o en casa si dominamos este conocimiento?
- **📖 Libro de Texto SEP:** Nuestros Saberes 2º Grado (Págs. 19 a la 22) — *Estructura de la carta, signos de puntuación y remitente/destinatario*
- **📦 Materiales:** Papel bond blanco, Plumones de colores, Material concreto o interactivo, Cuaderno del alumno
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)".
- **🌟 Cierre (10 min):**  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria) con la vida comunitaria.
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)" de manera sencilla para que cualquiera los entienda?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Creación de poemas, coplas, caligramas y rimas infantiles (2º de Primaria)" en tu vida diaria?
