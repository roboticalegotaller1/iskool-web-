...
```yaml
PDA: "Registra y resume información sobre 'Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)' a través de la escritura autónoma, el dibujo y el dictado al docente para compartir con la comunidad."
```
...
- *PDA:* Utiliza material concreto, dibujos y símbolos para representar cantidades, medidas y patrones vinculados a "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)".
- *Vínculo formativo:* Fundamentación lógica, conteo, medición y resolución de problemas prácticos cotidianos.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Reconoce el impacto de las acciones individuales y colectivas en relación con "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)" en su entorno escolar y familiar.
- *Vínculo formativo:* Compromiso ciudadano, cuidado del entorno y convivencia pacífica.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Participa en juegos y actividades colaborativas relacionadas con "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)", respetando acuerdos y turnos de participación.
...
Necesidad de fomentar la curiosidad científica, la indagación sistemática y la aplicación de saberes escolares para entender y transformar fenómenos relacionados con "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)"
- **⏱️ Inicio (10 min):**
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)?".
- **❓ Preguntas Clave de la Sesión:**
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)"?
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)".
...
- **❓ Preguntas Clave de la Sesión:**
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)"?
...
- **🔬 Desarrollo (30 min):**
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)".
- **🌟 Cierre (10 min):**
...
- **⏱️ Inicio (10 min):**
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)".
- **🔬 Desarrollo (30 min):**
...
- **❓ Preguntas Clave de la Sesión:**
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)"?
...
- **❓ Preguntas Clave de la Sesión:**
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)"?
...
- **🔬 Desarrollo (30 min):**
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria) con la vida comunitaria.
...
- **❓ Preguntas Clave de la Sesión:**
  1. ¿Cómo podemos explicar conceptos de "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)" de manera sencilla para que cualquiera los entienda?
...
- **🔬 Desarrollo (30 min):**
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)".
- **🌟 Cierre (10 min):**
...
- **❓ Preguntas Clave de la Sesión:**
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Impacto de las actividades humanas en la naturaleza y sustentabilidad (2º de Primaria)" en tu vida diaria?
- **📖 Libro de Texto SEP:** Proyectos de Aula 2º Grado (Págs. 82 a la 84) — *Proyectos colaborativos del aula*
