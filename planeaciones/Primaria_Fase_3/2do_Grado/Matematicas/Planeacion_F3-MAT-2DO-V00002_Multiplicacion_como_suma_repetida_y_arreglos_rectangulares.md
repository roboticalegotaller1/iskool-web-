---
title: "Proyecto Didáctico: Multiplicación como suma repetida y arreglos rectangulares (2º de Primaria)"
...
materia: "Matematicas"
tema: "Multiplicación como suma repetida y arreglos rectangulares"
codigo_curricular: "F3-MAT-2DO-V00002"
...
# 📚 Proyecto Didáctico Integral: Multiplicación como suma repetida y arreglos rectangulares
...
```yaml
PDA: "Resuelve problemas que implican calcular la cantidad total de elementos en arreglos rectangulares o colecciones de grupos iguales; comprende la multiplicación como sumas iteradas de sumandos iguales y utiliza el signo "×" en situaciones de la vida cotidiana."
```
...
- **⏱️ Inicio (10 min):**
  - Recuperación lúdica de saberes previos con material concreto, dinámicas de movimiento, ronda o pregunta detonadora: *"¿Qué sabemos sobre multiplicación como suma repetida y arreglos rectangulares y cómo lo usamos en nuestra casa o escuela?"*.
