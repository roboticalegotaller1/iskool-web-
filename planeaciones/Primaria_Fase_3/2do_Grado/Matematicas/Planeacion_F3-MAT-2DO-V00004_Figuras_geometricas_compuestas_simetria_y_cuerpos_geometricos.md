---
tags: [iskool, planeacion_nem, segundo_cerebro, boveda_curricular, nivel_primaria_media, materia_matematicas, grado_2_de_primaria]
...
tema: "Figuras Geométricas y Cuerpos del Entorno"
...
producto_integrador: "Exposición interactiva "Geometría en Nuestra Escuela" con maquetas a escala, cuerpos geométricos elaborados con desarrollos planos, planos arquitectónicos del salón y catálogo de polígonos del entorno."
fecha_elaboracion: "2 de septiembre de 2026"
created_at: "2 de septiembre de 2026"
updated_at: "2 de septiembre de 2026"
---

# 📚 Proyecto Didáctico Integral: Figuras Geométricas y Cuerpos del Entorno

> **Docente Titular:** [[Prof_Israel_Lopez_Angeles|Prof. Israel López Ángeles]]  
> **Nivel y Fase:** PRIMARIA-MEDIA • Fase 4 (2º de Primaria)  
> **Campo Formativo:** Saberes y Pensamiento Científico  
> **Asignatura:** Matematicas  
> **Temporalidad:** 10 sesiones de 50 minutos (Total: 500 min / 2 semanas lectivas)  
> **Producto Central Integrador:** *Exposición interactiva "Geometría en Nuestra Escuela" con maquetas a escala, cuerpos geométricos elaborados con desarrollos planos, planos arquitectónicos del salón y catálogo de polígonos del entorno.*  
...
```yaml
PDA: "Observa, formula hipótesis y experimenta para explicar fenómenos naturales y propiedades de la materia en torno a "Figuras Geométricas y Cuerpos del Entorno"."
```
...
Los estudiantes requieren aplicar nociones de geometría espacial, perímetros, áreas y simetría al diseño de espacios escolares y comunitarios seguros y funcionales vinculados a "Figuras Geométricas y Cuerpos del Entorno".

**Propósito del Proyecto:**  
Construir maquetas a escala y figuras geométricas tridimensionales aplicando fórmulas de área, perímetro y propiedades de los polígonos con base en los libros de texto SEP (Nuestros Saberes / Proyectos de Aula).

**Impacto Social y Transformador:**  
Permite a los estudiantes proponer mejoras tangibles al espacio escolar, mejorando la habitabilidad, accesibilidad y estética del entorno educativo.

---

## ❓ III. Preguntas Detonadoras para el Salón (Apertura y Conflicto Cognitivo)
1. ¿Cómo calculamos el perímetro y el área de espacios de nuestra escuela (canchas, jardines, salones) para proponer mejoras en "Figuras Geométricas y Cuerpos del Entorno"?
2. ¿Qué características distinguen a los prismas de las pirámides cuando armamos sus desarrollos planos en cartulina?
3. ¿De qué manera la simetría y los ángulos rectos hacen que las construcciones y edificios de nuestra comunidad sean estables y resistentes?

---

## 📅 IV. Secuencia Didáctica Completa (Dosificación en 10 Bloques de 50 Minutos)

### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Figuras Geométricas y Cuerpos del Entorno"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "Figuras Geométricas y Cuerpos del Entorno". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Figuras Geométricas y Cuerpos del Entorno" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Figuras Geométricas y Cuerpos del Entorno?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "Figuras Geométricas y Cuerpos del Entorno"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Figuras Geométricas y Cuerpos del Entorno".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "Figuras Geométricas y Cuerpos del Entorno"?  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Figuras Geométricas y Cuerpos del Entorno".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "Figuras Geométricas y Cuerpos del Entorno"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Figuras Geométricas y Cuerpos del Entorno"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Figuras Geométricas y Cuerpos del Entorno" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Figuras Geométricas y Cuerpos del Entorno con la vida comunitaria.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Figuras Geométricas y Cuerpos del Entorno".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "Figuras Geométricas y Cuerpos del Entorno" en tu vida diaria?
- **📖 Libro de Texto SEP:** Proyectos de Aula 3º Grado (Págs. 114 a la 116) — *Cálculo de áreas, perímetros y presupuestos comunitarios*
...
| :--- | :--- | :--- | :--- |
| **Identificación de Propiedades Geométricas y Medición** | Identifica con precisión lados, vértices, aristas y ángulos en figuras y cuerpos, calculando perímetros y áreas sin errores. | Reconoce las figuras geométricas principales y aplica fórmulas básicas de medición. | Confunde figuras bidimensionales con cuerpos 3D o presenta errores constantes de medición. |
| **Construcción de Maquetas y Desarrollos Planos** | Arma cuerpos geométricos y maquetas a escala con gran precisión, simetría, resistencia estructural y estética impecable. | Elabora sus modelos geométricos con orden y limpieza respetando las dimensiones básicas. | Los modelos geométricos son frágiles o deformes. |
| **Socialización y Explicación del Diseño Espacial** | Explica con elocuencia las propiedades geométricas y la utilidad comunitaria de su diseño ante los visitantes de la muestra. | Expone su maqueta con claridad y amabilidad durante el recorrido escolar. | Muestra dificultad para justificar el uso de las figuras geométricas en su maqueta. |
...
- Evidencia final del proyecto: **Exposición interactiva "Geometría en Nuestra Escuela" con maquetas a escala, cuerpos geométricos elaborados con desarrollos planos, planos arquitectónicos del salón y catálogo de polígonos del entorno.**.
