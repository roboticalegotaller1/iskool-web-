---
title: "Proyecto Didáctico: Cuerpos geométricos y figuras planas con el tangram (1º de Primaria)"
...
materia: "Matematicas"
tema: "Cuerpos geométricos y figuras planas con el tangram"
codigo_curricular: "F3-MAT-1ER-V05543"
...
# 📚 Proyecto Didáctico Integral: Cuerpos geométricos y figuras planas con el tangram
...
```yaml
PDA: "Observa y manipula objetos de su entorno y los clasifica de acuerdo con sus características geométricas (caras planas o curvas, lados rectos o curvos). Representa animales, plantas u objetos utilizando el tangram y otras figuras geométricas planas, reconociendo el círculo, cuadrado, triángulo y rectángulo."
```
...
- **⏱️ Inicio (10 min):**
  - Recuperación lúdica de saberes previos con material concreto, dinámicas de movimiento, ronda o pregunta detonadora: *"¿Qué sabemos sobre cuerpos geométricos y figuras planas con el tangram y cómo lo usamos en nuestra casa o escuela?"*.
