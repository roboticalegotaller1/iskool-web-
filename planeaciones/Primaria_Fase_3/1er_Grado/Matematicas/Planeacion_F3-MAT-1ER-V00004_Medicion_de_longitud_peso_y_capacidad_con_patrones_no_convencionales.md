...
1. ¿Cómo utilizamos la rima consonante, el conteo de sílabas y las metáforas para darle musicalidad a nuestros versos sobre "Medición de longitud, peso y capacidad con patrones no convencionales (1º de Primaria)"?
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Activación temática y exploración de saberes previos. El docente plantea la pregunta central y conflicto cognitivo sobre "Medición de longitud, peso y capacidad con patrones no convencionales (1º de Primaria)". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos situaciones sobre "Medición de longitud, peso y capacidad con patrones no convencionales (1º de Primaria)"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué ideas y explicaciones nuevas encontramos hoy en el libro de la SEP respecto a "Medición de longitud, peso y capacidad con patrones no convencionales (1º de Primaria)"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver un mismo problema sobre "Medición de longitud, peso y capacidad con patrones no convencionales (1º de Primaria)"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando lo que aprendiste sobre "Medición de longitud, peso y capacidad con patrones no convencionales (1º de Primaria)" en tu vida diaria?
- **📖 Libro de Texto SEP:** Proyectos de Aula 3º Grado (Págs. 114 a la 116) — *Cálculo de áreas, perímetros y presupuestos comunitarios*
