...
tema: "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)"
...
# 📚 Proyecto Didáctico Integral: El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)
...
```yaml
PDA: "Registra y resume información sobre "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)" a través de la escritura autónoma, el dibujo y el dictado al docente para compartir con la comunidad."
```
...
- *PDA:* Utiliza material concreto, dibujos y símbolos para representar cantidades, medidas y patrones vinculados a "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)".
- *Vínculo formativo:* Fundamentación lógica, conteo, medición y resolución de problemas prácticos cotidianos.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Reconoce el impacto de las acciones individuales y colectivas en relación con "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)" en su entorno escolar y familiar.
- *Vínculo formativo:* Compromiso ciudadano, cuidado del entorno y convivencia pacífica.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Participa en juegos y actividades colaborativas relacionadas con "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)", respetando acuerdos y turnos de participación.
...
Necesidad de fomentar la curiosidad científica, la indagación sistemática y la aplicación de saberes escolares para entender y transformar fenómenos relacionados con "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)"?  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)".
- **🌟 Cierre (10 min):**  
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)"?  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)"?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria) con la vida comunitaria.
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)" de manera sencilla para que cualquiera los entienda?  
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "El cuerpo humano, los cinco sentidos y hábitos de higiene (1º de Primaria)" en tu vida diaria?
