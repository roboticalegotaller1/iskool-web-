...
```yaml
PDA: "Registra y resume información sobre "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)" a través de la escritura autónoma, el dibujo y el dictado al docente para compartir con la comunidad."
```
...
- *PDA:* Utiliza material concreto, dibujos y símbolos para representar cantidades, medidas y patrones vinculados a "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)".
- *Vínculo formativo:* Fundamentación lógica, conteo, medición y resolución de problemas prácticos cotidianos.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Reconoce el impacto de las acciones individuales y colectivas en relación con "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)" en su entorno escolar y familiar.
- *Vínculo formativo:* Compromiso ciudadano, cuidado del entorno y convivencia pacífica.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Participa en juegos y actividades colaborativas relacionadas con "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)", respetando acuerdos y turnos de participación.
...
Necesidad de fomentar la curiosidad científica, la indagación sistemática y la aplicación de saberes escolares para entender y transformar fenómenos relacionados con "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)"?  
  2. ¿Qué problema podríamos resolver en la escuela o en casa si dominamos este conocimiento?
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 1º y 2º Grado (Págs. 108 a la 111) — *El huerto escolar, reciclaje y cuidado del agua*
- **📦 Materiales:** Papel bond blanco, Plumones de colores, Material concreto o interactivo, Cuaderno del alumno
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)"?  
  2. ¿Cómo se relacionan estas definiciones con los ejemplos que analizamos en la sesión anterior?
- **📖 Libro de Texto SEP:** Proyectos Escolares 2º Grado (Págs. 127 a la 130) — *Estados de la materia, fuentes de luz y sonido*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)".
- **🌟 Cierre (10 min):**  
...
- **📖 Libro de Texto SEP:** Nuestros Saberes: Libro para alumnos, maestros y familia 1º y 2º (Págs. 92 a la 95) — *Los 5 sentidos, plantas, animales y cuidado de la salud*
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)"?  
  2. ¿Cuál es el método más claro para explicar tu respuesta a los demás?
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 1º y 2º Grado (Págs. 117 a la 120) — *El huerto escolar, reciclaje y cuidado del agua*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)"?  
  2. ¿Cómo organizamos los datos para que cualquier persona de la comunidad los entienda con claridad?
- **📖 Libro de Texto SEP:** Proyectos Escolares 2º Grado (Págs. 136 a la 139) — *Estados de la materia, fuentes de luz y sonido*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📖 Libro de Texto SEP:** Nuestros Saberes: Libro para alumnos, maestros y familia 1º y 2º (Págs. 101 a la 104) — *Los 5 sentidos, plantas, animales y cuidado de la salud*
- **📦 Materiales:** Material artístico / cartulinas, Textos informativos complementarios, Plumones
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria) con la vida comunitaria.
...
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 1º y 2º Grado (Págs. 126 a la 129) — *El huerto escolar, reciclaje y cuidado del agua*
...
- **📖 Libro de Texto SEP:** Proyectos Escolares 2º Grado (Págs. 145 a la 148) — *Estados de la materia, fuentes de luz y sonido*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)" de manera sencilla para que cualquiera los entienda?  
  2. ¿Qué tono de voz y postura corporal transmiten seguridad y entusiasmo en nuestra presentación?
- **📖 Libro de Texto SEP:** Nuestros Saberes: Libro para alumnos, maestros y familia 1º y 2º (Págs. 110 a la 113) — *Los 5 sentidos, plantas, animales y cuidado de la salud*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Capacidades y habilidades motrices en juegos colaborativos (1º de Primaria)" en tu vida diaria?
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 1º y 2º Grado (Págs. 135 a la 138) — *El huerto escolar, reciclaje y cuidado del agua*
