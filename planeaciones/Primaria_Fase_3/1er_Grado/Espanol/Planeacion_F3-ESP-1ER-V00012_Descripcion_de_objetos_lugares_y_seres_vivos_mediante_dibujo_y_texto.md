...
```yaml
PDA: "Registra y resume información sobre "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)" a través de la escritura autónoma, el dibujo y el dictado al docente para compartir con la comunidad."
```
...
- *PDA:* Utiliza material concreto, dibujos y símbolos para representar cantidades, medidas y patrones vinculados a "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)".
- *Vínculo formativo:* Fundamentación lógica, conteo, medición y resolución de problemas prácticos cotidianos.

**3. Ética, Naturaleza y Sociedades:**
- *PDA:* Reconoce el impacto de las acciones individuales y colectivas en relación con "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)" en su entorno escolar y familiar.
- *Vínculo formativo:* Compromiso ciudadano, cuidado del entorno y convivencia pacífica.

**4. De lo Humano y lo Comunitario:**
- *PDA:* Participa en juegos y actividades colaborativas relacionadas con "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)", respetando acuerdos y turnos de participación.
...
Falta de medios impresos o digitales escolares donde las niñas y niños puedan comunicar hallazgos, opiniones fundamentadas y propuestas de mejora sobre "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)" para la comunidad.

**Propósito del Proyecto:**  
Desarrollar habilidades de investigación documental, redacción de textos informativos y argumentativos, y diseño editorial para socializar el tema de "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)".
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Reto Comunitario y Activación de Saberes sobre "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)"
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Dinámica detonadora "La Caja de Saberes". El docente plantea la pregunta central y conflicto cognitivo sobre "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)". Los alumnos comparten sus experiencias cotidianas y registran en el pizarrón lo que ya saben.
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Exploración con material manipulable y organizadores gráficos en equipos de 4 alumnos. Cada equipo analiza una situación real vinculada a "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)" y elabora su primer registro diagnóstico.
- **🌟 Cierre (10 min):**  
  ⏱️ CIERRE (10 min): Puesta en común de hallazgos iniciales. Cada equipo expresa en una frase su meta de aprendizaje. Registro individual en bitácora: "¿Qué descubrí hoy sobre Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)?".
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿En qué momentos de nuestra vida cotidiana o en nuestra comunidad observamos o utilizamos "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)"?  
  2. ¿Qué problema podríamos resolver en la escuela o en casa si dominamos este conocimiento?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 1º y 2º Grado (Págs. 28 a la 31) — *Cuentos, textos epistolares y narraciones infantiles*
- **📦 Materiales:** Papel bond blanco, Plumones de colores, Material concreto o interactivo, Cuaderno del alumno
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #1: Diagnóstico inicial de saberes previos y mapa mental grupal sobre "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)".
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué conceptos nuevos aprendimos hoy en el libro de la SEP respecto a "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)"?  
  2. ¿Cómo se relacionan estas definiciones con los ejemplos que analizamos en la sesión anterior?
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 2º Grado (Págs. 85 a la 88) — *Correspondencia escolar, cartas a la comunidad y buzón postal*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Trabajo en estaciones rotativas de indagación y manipulación práctica. Los alumnos aplican procedimientos directos, tabulan datos o construyen representaciones tangibles sobre "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)".
- **🌟 Cierre (10 min):**  
...
- **📖 Libro de Texto SEP:** Proyectos de Aula 1º y 2º Grado (Págs. 60 a la 63) — *Producción de textos, cartas personales y dictado colectivo*
...
- **⏱️ Inicio (10 min):**  
  ⏱️ INICIO (10 min): Planteamiento de una problemática real de la comunidad escolar vinculada a "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)".
- **🔬 Desarrollo (30 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Por qué existen diferentes formas de resolver el mismo problema sobre "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)"?  
  2. ¿Cuál es el método más claro para explicar tu respuesta a los demás?
- **📖 Libro de Texto SEP:** Nuestros Saberes 2º Grado (Págs. 31 a la 34) — *Estructura de la carta, signos de puntuación y remitente/destinatario*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué información clave no puede faltar en nuestro producto sobre "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)"?  
  2. ¿Cómo organizamos los datos para que cualquier persona de la comunidad los entienda con claridad?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 1º y 2º Grado (Págs. 40 a la 43) — *Cuentos, textos epistolares y narraciones infantiles*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Actividad integradora que combina "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)" con la expresión artística, el análisis ético o la redacción formal de propuestas comunitarias.
- **🌟 Cierre (10 min):**  
...
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 2º Grado (Págs. 97 a la 100) — *Correspondencia escolar, cartas a la comunidad y buzón postal*
- **📦 Materiales:** Material artístico / cartulinas, Textos informativos complementarios, Plumones
- **📄 Entregable de la Sesión:** 📄 Ficha de Trabajo #6: Producto interdisciplinario que vincula Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria) con la vida comunitaria.
...
- **📖 Libro de Texto SEP:** Proyectos de Aula 1º y 2º Grado (Págs. 72 a la 75) — *Producción de textos, cartas personales y dictado colectivo*
...
- **📖 Libro de Texto SEP:** Nuestros Saberes 2º Grado (Págs. 43 a la 46) — *Estructura de la carta, signos de puntuación y remitente/destinatario*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cómo podemos explicar conceptos de "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)" de manera sencilla para que cualquiera los entienda?  
  2. ¿Qué tono de voz y postura corporal transmiten seguridad y entusiasmo en nuestra presentación?
- **📖 Libro de Texto SEP:** Múltiples Lenguajes 1º y 2º Grado (Págs. 52 a la 55) — *Cuentos, textos epistolares y narraciones infantiles*
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Presentación de la Feria de Aprendizajes ante compañeros de otros grupos, docentes o padres de familia. Demostración práctica de los conocimientos adquiridos sobre "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)".
- **🌟 Cierre (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  ...
  2. ¿Cómo vas a seguir utilizando este conocimiento sobre "Descripción de objetos, lugares y seres vivos mediante dibujo y texto (1º de Primaria)" en tu vida diaria?
- **📖 Libro de Texto SEP:** Proyectos Comunitarios 2º Grado (Págs. 109 a la 112) — *Correspondencia escolar, cartas a la comunidad y buzón postal*
