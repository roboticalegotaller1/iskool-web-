---
title: "Proyecto Didáctico: Lectura compartida en voz alta de cuentos, coplas y rimas infantiles (1º de Primaria)"
...
materia: "Espanol"
tema: "Lectura compartida en voz alta de cuentos, coplas y rimas infantiles"
codigo_curricular: "F3-ESP-1ER-V09110"
...
# 📚 Proyecto Didáctico Integral: Lectura compartida en voz alta de cuentos, coplas y rimas infantiles
...
```yaml
PDA: "Reconoce que se lee de izquierda a derecha y de arriba abajo; sigue la lectura en voz alta que hace el docente, expresa sus emociones sobre las historias y anticipa contenidos a partir de ilustraciones."
```
...
- **⏱️ Inicio (10 min):**
  - Recuperación lúdica de saberes previos con material concreto, dinámicas de movimiento, ronda o pregunta detonadora: *"¿Qué sabemos sobre lectura compartida en voz alta de cuentos, coplas y rimas infantiles y cómo lo usamos en nuestra casa o escuela?"*.
