...
codigo_curricular: "F3-ESP-1ER-V04811"
...
En la comunidad escolar (Comunitario Originario), los estudiantes de 1º de Primaria han observado un reto cotidiano: Escucha de leyendas de los abuelos, palabras en lengua materna y respeto a las faenas escolares.. A través del abordaje del tema "Narración de vivencias y eventos cotidianos en orden cronológico", los alumnos se involucrarán de forma activa y lúdica aplicando la metodología de Aprendizaje Basado en Problemas (ABP Lúdico), logrando una experiencia formativa significativa que culminará en el desarrollo de un producto tangible: Libro ilustrado de conteo y problemas matemáticos de la tiendita escolar.
