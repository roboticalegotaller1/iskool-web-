---
tags: [iskool, planeacion_nem, segundo_cerebro, boveda_curricular, nivel_secundaria, materia_matematicas, grado_2do_grado]
...
> **Nivel y Fase:** SECUNDARIA • Fase 6 (2do Grado)  
...
Los estudiantes requieren fortalecer el razonamiento lógico-matemático aplicado a situaciones de la vida real relacionadas con "Ingeniería en el Patio Escolar: Aplicando el Teorema de Pitágoras en la Vida Real" para resolver retos del entorno.
...
### 📌 SESIÓN 1 (50 minutos): Planteamiento del Problema, Conflicto Cognitivo y Formulación de Hipótesis sobre "Ingeniería en el Patio Escolar: Aplicando el Teorema de Pitágoras en la Vida Real"
- **⏱️ Inicio (10 min):**  
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Cuáles son las variables dependientes e independientes que intervienen en el fenómeno de "Ingeniería en el Patio Escolar: Aplicando el Teorema de Pitágoras en la Vida Real"?  
  2. ¿Qué evidencias empíricas necesitamos para validar o refutar nuestras hipótesis iniciales?
- **📖 Libro de Texto SEP:** Saberes y Pensamiento Científico: Matemáticas (1º, 2º y 3º Secundaria) (Págs. 91 a la 94) — *Álgebra, funciones lineales y cuadráticas, teorema de Pitágoras y probabilidad*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué leyes, principios o hechos históricos explican con rigor el fenómeno de "Ingeniería en el Patio Escolar: Aplicando el Teorema de Pitágoras en la Vida Real"?  
  2. ¿Cómo contrastan estos hallazgos con las ideas previas del equipo?
- **📖 Libro de Texto SEP:** Colección Ximhai / Sk’asolil Matemáticas Secundaria (Págs. 146 a la 149) — *Modelación algebraica y resolución de problemas situados*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué leyes, principios o hechos históricos explican con rigor el fenómeno de "Ingeniería en el Patio Escolar: Aplicando el Teorema de Pitágoras en la Vida Real"?  
  2. ¿Cómo contrastan estos hallazgos con las ideas previas del equipo?
- **📖 Libro de Texto SEP:** Saberes y Pensamiento Científico: Matemáticas (1º, 2º y 3º Secundaria) (Págs. 97 a la 100) — *Álgebra, funciones lineales y cuadráticas, teorema de Pitágoras y probabilidad*
- **📦 Materiales:** Libros de texto gratuitos SEP de Secundaria, Fichas de trabajo analítico, Calculadora / regla
- **📄 Entregable de la Sesión:** 📄 Ficha Teórica #2: Cuadro comparativo y síntesis analítica con citas bibliográficas oficiales.
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué leyes, principios o hechos históricos explican con rigor el fenómeno de "Ingeniería en el Patio Escolar: Aplicando el Teorema de Pitágoras en la Vida Real"?  
  2. ¿Cómo contrastan estos hallazgos con las ideas previas del equipo?
- **📖 Libro de Texto SEP:** Colección Ximhai / Sk’asolil Matemáticas Secundaria (Págs. 152 a la 155) — *Modelación algebraica y resolución de problemas situados*
- **📦 Materiales:** Libros de texto gratuitos SEP de Secundaria, Fichas de trabajo analítico, Calculadora / regla
- **📄 Entregable de la Sesión:** 📄 Ficha Teórica #2: Cuadro comparativo y síntesis analítica con citas bibliográficas oficiales.
...
- **📖 Libro de Texto SEP:** Saberes y Pensamiento Científico: Matemáticas (1º, 2º y 3º Secundaria) (Págs. 103 a la 106) — *Álgebra, funciones lineales y cuadráticas, teorema de Pitágoras y probabilidad*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué comportamiento matemático o físico describen los datos obtenidos en la práctica?  
  2. ¿Qué correlación existe entre las variables analizadas?
- **📖 Libro de Texto SEP:** Colección Ximhai / Sk’asolil Matemáticas Secundaria (Págs. 158 a la 161) — *Modelación algebraica y resolución de problemas situados*
- **📦 Materiales:** Instrumental de laboratorio o simuladores digitales, Hojas de tabulación milimétricas, Bitácora
- **📄 Entregable de la Sesión:** 📄 Reporte de Práctica #3: Tabulación rigurosa de datos, gráficas de comportamiento y análisis cuantitativo.
...
- **🔬 Desarrollo (30 min):**  
  ⏱️ DESARROLLO (30 min): Debate estructurado con argumentación fundamentada sobre las implicaciones éticas, sociales o tecnológicas de "Ingeniería en el Patio Escolar: Aplicando el Teorema de Pitágoras en la Vida Real". Coevaluación con rúbrica técnica.
- **🌟 Cierre (10 min):**  
...
- **📖 Libro de Texto SEP:** Saberes y Pensamiento Científico: Matemáticas (1º, 2º y 3º Secundaria) (Págs. 109 a la 112) — *Álgebra, funciones lineales y cuadráticas, teorema de Pitágoras y probabilidad*
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué argumentos demostraron mayor solidez y rigor conceptual durante la discusión?  
  2. ¿Cuál es la responsabilidad social de la ciencia y la tecnología en torno a "Ingeniería en el Patio Escolar: Aplicando el Teorema de Pitágoras en la Vida Real"?
- **📖 Libro de Texto SEP:** Colección Ximhai / Sk’asolil Matemáticas Secundaria (Págs. 164 a la 167) — *Modelación algebraica y resolución de problemas situados*
- **📦 Materiales:** Rúbricas técnicas de evaluación entre pares, Guiones de argumentación
- **📄 Entregable de la Sesión:** 📄 Acta de Debate y Rúbrica de Coevaluación con argumentos fundamentados.
...
- **❓ Preguntas Clave de la Sesión:**  
  1. ¿Qué argumentos demostraron mayor solidez y rigor conceptual durante la discusión?  
  2. ¿Cuál es la responsabilidad social de la ciencia y la tecnología en torno a "Ingeniería en el Patio Escolar: Aplicando el Teorema de Pitágoras en la Vida Real"?
- **📖 Libro de Texto SEP:** Saberes y Pensamiento Científico: Matemáticas (1º, 2º y 3º Secundaria) (Págs. 115 a la 118) — *Álgebra, funciones lineales y cuadráticas, teorema de Pitágoras y probabilidad*
- **📦 Materiales:** Rúbricas técnicas de evaluación entre pares, Guiones de argumentación
- **📄 Entregable de la Sesión:** 📄 Acta de Debate y Rúbrica de Coevaluación con argumentos fundamentados.
...
- **📖 Libro de Texto SEP:** Colección Ximhai / Sk’asolil Matemáticas Secundaria (Págs. 170 a la 173) — *Modelación algebraica y resolución de problemas situados*
