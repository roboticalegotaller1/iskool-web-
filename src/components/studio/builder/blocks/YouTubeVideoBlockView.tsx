...
export const YouTubeVideoBlockView: React.FC<Props> = ({ block }) => {
  ...
  const { videoUrl, videoTitle, mustWatchEntirely } = block.data;

  // Extraer ID de video de YouTube para vista previa
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1">
        ...
        <input
          ...
          placeholder="Ej. El Abrazo de Acatempan explicado en 3 minutos..."
