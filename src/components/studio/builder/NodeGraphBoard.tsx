...
export const NodeGraphBoard: React.FC = () => {
  ...
  // Manejar carga de plantilla rápida de Independencia de México
  ...
  return (
    <div 
      ref={boardRef}
      className="relative w-full h-[680px] sm:h-[760px] rounded-3xl overflow-hidden select-none border border-slate-200/90 dark:border-zinc-800 bg-[#f8fafc] dark:bg-[#090d16] shadow-inner"
      style={{
        backgroundImage: `radial-gradient(circle, rgba(148, 163, 184, 0.25) 1.2px, transparent 1.2px)`,
        backgroundSize: '24px 24px',
      }}
    >
      {/* Contenedor con Escala de Zoom */}
      <div 
        className="absolute inset-0 w-full h-full transform origin-top-left transition-transform duration-75"
        style={{ transform: `scale(${zoomLevel})` }}
      >
        {/* Capa de Flechas SVG estilo n8n */}
        <svg className="absolute inset-0 w-[4000px] h-[3000px] pointer-events-none z-10">
          <defs>
          ...
          {connections.map((conn) => {
            ...
            return (
              ...
              >
                ...
                {/* Línea visible de la flecha con gradiente / animación */}
                <path
                  d={pathD}
                  fill="none"
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center space-y-6 animate-fade-in z-20">
            ...
            <div className="space-y-2 max-w-md">
              ...
              <p className="text-xs text-slate-600 dark:text-zinc-400 leading-relaxed">
                Diseña tu lección como un mapa de flujo estilo n8n. Agrega nodos interactivos, conéctalos con flechas y define rutas dinámicas para tus alumnos.
              </p>
            </div>
