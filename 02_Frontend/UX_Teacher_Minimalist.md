...
| **🎨 Crear Actividad** *(Hero)* | `/teacher/Lienzo Digital` | `bg-gradient-to-b from-purple-600 via-violet-600 to-indigo-700`, `ring-4 ring-purple-500/20`, insignia animada. | Abre el estudio de creación **Estudio ISkool**. |
